...
function dataFormatoT2do($unidad, $turnado, $fecha, $mesSearch, $status) {
    ...
    $var_cursos = DB::table('tbl_cursos as c')
        ->select(
            ...
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 1 and ins.sexo='M' THEN 1 ELSE 0 END) as gv1m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 1 and ins.sexo='H' THEN 1 ELSE 0 END) as gv1h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 1 and ins.lgbt = true THEN 1 ELSE 0 END) as gv1l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 2 and ins.sexo='M' THEN 1 ELSE 0 END) as gv2m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 2 and ins.sexo='H' THEN 1 ELSE 0 END) as gv2h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 2 and ins.lgbt = true THEN 1 ELSE 0 END) as gv2l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 3 and ins.sexo='M' THEN 1 ELSE 0 END) as gv3m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 3 and ins.sexo='H' THEN 1 ELSE 0 END) as gv3h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 3 and ins.lgbt = true THEN 1 ELSE 0 END) as gv3l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 4 and ins.sexo='M' THEN 1 ELSE 0 END) as gv4m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 4 and ins.sexo='H' THEN 1 ELSE 0 END) as gv4h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 4 and ins.lgbt = true THEN 1 ELSE 0 END) as gv4l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 5 and ins.sexo='M' THEN 1 ELSE 0 END) as gv5m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 5 and ins.sexo='H' THEN 1 ELSE 0 END) as gv5h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 5 and ins.lgbt = true THEN 1 ELSE 0 END) as gv5l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 6 and ins.sexo='M' THEN 1 ELSE 0 END) as gv6m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 6 and ins.sexo='H' THEN 1 ELSE 0 END) as gv6h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 6 and ins.lgbt = true THEN 1 ELSE 0 END) as gv6l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 7 and ins.sexo='M' THEN 1 ELSE 0 END) as gv7m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 7 and ins.sexo='H' THEN 1 ELSE 0 END) as gv7h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 7 and ins.lgbt = true THEN 1 ELSE 0 END) as gv7l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 8 and ins.sexo='M' THEN 1 ELSE 0 END) as gv8m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 8 and ins.sexo='H' THEN 1 ELSE 0 END) as gv8h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 8 and ins.lgbt = true THEN 1 ELSE 0 END) as gv8l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 9 and ins.sexo='M' THEN 1 ELSE 0 END) as gv9m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 9 and ins.sexo='H' THEN 1 ELSE 0 END) as gv9h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 9 and ins.lgbt = true THEN 1 ELSE 0 END) as gv9l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 10 and ins.sexo='M' THEN 1 ELSE 0 END) as gv10m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 10 and ins.sexo='H' THEN 1 ELSE 0 END) as gv10h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 10 and ins.lgbt = true THEN 1 ELSE 0 END) as gv10l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 11 and ins.sexo='M' THEN 1 ELSE 0 END) as gv11m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 11 and ins.sexo='H' THEN 1 ELSE 0 END) as gv11h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 11 and ins.lgbt = true THEN 1 ELSE 0 END) as gv11l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 12 and ins.sexo='M' THEN 1 ELSE 0 END) as gv12m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 12 and ins.sexo='H' THEN 1 ELSE 0 END) as gv12h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 12 and ins.lgbt = true THEN 1 ELSE 0 END) as gv12l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 13 and ins.sexo='M' THEN 1 ELSE 0 END) as gv13m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 13 and ins.sexo='H' THEN 1 ELSE 0 END) as gv13h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 13 and ins.lgbt = true THEN 1 ELSE 0 END) as gv13l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 14 and ins.sexo='M' THEN 1 ELSE 0 END) as gv14m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 14 and ins.sexo='H' THEN 1 ELSE 0 END) as gv14h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 14 and ins.lgbt = true THEN 1 ELSE 0 END) as gv14l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 15 and ins.sexo='M' THEN 1 ELSE 0 END) as gv15m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 15 and ins.sexo='H' THEN 1 ELSE 0 END) as gv15h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 15 and ins.lgbt = true THEN 1 ELSE 0 END) as gv15l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 16 and ins.sexo='M' THEN 1 ELSE 0 END) as gv16m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 16 and ins.sexo='H' THEN 1 ELSE 0 END) as gv16h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 16 and ins.lgbt = true THEN 1 ELSE 0 END) as gv16l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 17 and ins.sexo='M' THEN 1 ELSE 0 END) as gv17m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 17 and ins.sexo='H' THEN 1 ELSE 0 END) as gv17h"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 17 and ins.lgbt = true THEN 1 ELSE 0 END) as gv17l"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 18 and ins.sexo='M' THEN 1 ELSE 0 END) as gv18m"),
            DB::raw("SUM(CASE WHEN ins.id_gvulnerable = 18 and ins.sexo='H' THEN 1 ELSE 0 END) as gv18h"),
