...
function dataFormatoT($unidad, $status, $fecha) {
    $var_cursos = DB::table('tbl_cursos as c')
        ->select(
            ...
            DB::raw("sum(case when ins.id_gvulnerable::text like '%9%' then 1 else 0 end) as migrante"),
            ...
            DB::raw("c.observaciones_formato_t->'OBSERVACION_FIRMA' AS observaciones_firma"),
             ...
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%1%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%1%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv1m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%1%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%1%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv1h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%1%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv1l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%2%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%2%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv2m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%2%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%2%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv2h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%2%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv2l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%3%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%3%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv3m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%3%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%3%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv3h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%3%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv3l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%4%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%4%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv4m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%4%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%4%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv4h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%4%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv4l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%5%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%5%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv5m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%5%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%5%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv5h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%5%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv5l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%6%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%6%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv6m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%6%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%6%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv6h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%6%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv6l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%7%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%7%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv7m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%7%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%7%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv7h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%7%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv7l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%8%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%8%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv8m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%8%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%8%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv8h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%8%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv8l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%9%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%9%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv9m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%9%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%9%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv9h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%9%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv9l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%10%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%10%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv10m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%10%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%10%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv10h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%10%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv10l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%11%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%11%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv11m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%11%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%11%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv11h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%11%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv11l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%12%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%12%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv12m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%12%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%12%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv12h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%12%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv12l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%13%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%13%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv13m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%13%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%13%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv13h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%13%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv13l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%14%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%14%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv14m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%14%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%14%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv14h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%14%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv14l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%15%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%15%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv15m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%15%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%15%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv15h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%15%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv15l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%16%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%16%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv16m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%16%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%16%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv16h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%16%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv16l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%17%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%17%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv17m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%17%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%17%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv17h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%17%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv17l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%18%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%18%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv18m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%18%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%18%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv18h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%18%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv18l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%19%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%19%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv19m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%19%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%19%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv19h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%19%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv19l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%20%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%20%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv20m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%20%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%20%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv20h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%20%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv20l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%21%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%21%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv21m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%21%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%21%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv21h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%21%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv21l"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%22%' and ins.sexo='M' and ins.lgbt = false or ins.id_gvulnerable::text like '%22%' and ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END) as gv22m"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%22%' and ins.sexo='H' and ins.lgbt = false or ins.id_gvulnerable::text like '%22%' and ins.sexo='H' and ins.lgbt is null THEN 1 ELSE 0 END) as gv22h"),
             DB::raw("SUM(CASE WHEN ins.id_gvulnerable::text like '%22%' and ins.lgbt = true THEN 1 ELSE 0 END) as gv22l"),
            // --- FIN RUBRO ESTATAL ---
...
function dataFormatoT2do($unidad, $turnado, $fecha, $mesSearch, $status) {
    ...
    $var_cursos = DB::table('tbl_cursos as c')
        ->select(
            ...
            DB::raw("SUM(CASE WHEN ins.sexo='H' THEN 1 ELSE 0 END) as ihombre"),
            DB::raw("SUM(CASE WHEN ins.lgbt = true THEN 1 ELSE 0 END) as ilgbt"),
            // --- SUMA DE INSCRITOS RESTANDOLE LGBT ---
            // DB::raw("SUM(CASE WHEN ins.sexo = 'M' and ins.lgbt = false or ins.sexo = 'M' and ins.lgbt is null THEN 1 ELSE 0 END) as imujer"),
            // DB::raw("SUM(CASE WHEN ins.sexo = 'H' and ins.lgbt = false or ins.sexo = 'H' and ins.lgbt is null THEN 1 ELSE 0 END) as ihombre"),
            // DB::raw("SUM(CASE WHEN ins.lgbt = true THEN 1 ELSE 0 END) as ilgbt"),
            ...
            DB::raw("SUM(CASE WHEN ins.calificacion <> 'NP' and ins.sexo='H' THEN 1 ELSE 0 END) as ehombre"),
            DB::raw("SUM(CASE WHEN ins.calificacion <> 'NP' and ins.lgbt = true THEN 1 ELSE 0 END) as elgbt"),
            // --- SUMA DE EGRESADOS RESTANDOLE LGBT ---
            // DB::raw("SUM(CASE WHEN ins.calificacion <> 'NP' and ins.sexo = 'M' and ins.lgbt = false or ins.calificacion <> 'NP' and ins.sexo = 'M' and ins.lgbt is null THEN 1 ELSE 0 END) as emujer"),
            // DB::raw("SUM(CASE WHEN ins.calificacion <> 'NP' and ins.sexo = 'H' and ins.lgbt = false or ins.calificacion <> 'NP' and ins.sexo = 'H' and ins.lgbt is null THEN 1 ELSE 0 END) as ehombre"),
            // DB::raw("SUM(CASE WHEN ins.calificacion <> 'NP' and ins.lgbt = true THEN 1 ELSE 0 END) as elgbt"),
            ...
            // --- SUMA DE EXONERACION TOTAL RESTANDOLE LGBT ---
            // DB::raw("sum(case when ins.abrinscri='ET' and ins.sexo='M' and ins.lgbt = false or ins.abrinscri='ET' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as etmujer"),
            // DB::raw("sum(case when ins.abrinscri='ET' and ins.sexo='H' and ins.lgbt = false or ins.abrinscri='ET' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as ethombre"),
            // DB::raw("sum(case when ins.abrinscri='ET' and ins.lgbt = true then 1 else 0 end) as etlgbt"),
            // --- SUMA DE EXONERACION PARCIAL RESTANDOLE LGBT ---
            // DB::raw("sum(case when ins.abrinscri='EP' and ins.sexo='M' and ins.lgbt = false or ins.abrinscri='EP' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as epmujer"),
            // DB::raw("sum(case when ins.abrinscri='EP' and ins.sexo='H' and ins.lgbt = false or ins.abrinscri='EP' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as ephombre"),
            // DB::raw("sum(case when ins.abrinscri='EP' and ins.lgbt = true then 1 else 0 end) as eplgbt"),
            ...
            // --- RANGO DE EDADES EN RUBRO ESTATAL SIN RESTAR LGBT ---
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) < 6 and ins.sexo='M' then 1 else 0 end) as iem1"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) < 6 and ins.sexo='H' then 1 else 0 end) as ieh1"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) < 6 and ins.lgbt = true then 1 else 0 end) as iel1"),
            DB::raw("sum( CASE WHEN EXTRACT(YEAR FROM (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 AND ins.sexo = 'M' THEN 1  ELSE 0 END ) as iem2"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 and ins.sexo = 'H' then 1 else 0 end) as ieh2"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 and ins.lgbt = true then 1 else 0 end) as iel2"),
            DB::raw("sum( CASE WHEN EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 AND ins.sexo='M' THEN 1 ELSE 0  END ) as iem3"),
            DB::raw("sum( Case When EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 and ins.sexo='H' then 1 else 0 end) as ieh3"),
            DB::raw("sum( Case When EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 and ins.lgbt = true then 1 else 0 end) as iel3"),
            DB::raw("sum( CASE WHEN EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29  AND ins.sexo='M' THEN 1 ELSE 0 END ) as iem4"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29 AND ins.sexo= 'H' then 1 else 0 end) as ieh4"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29 AND ins.lgbt = true then 1 else 0 end) as iel4"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 30 and 59 AND ins.sexo='M' then 1 else 0 end) as iem5"),
            DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 30 and 59 AND ins.sexo='H' then 1 else 0 end) as ieh5"),
            ...
            // --- RANGO DE EDADES EN RUBRO ESTATAL RESTANDOLE LGBT ---
            ...
            // DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) < 6 and ins.lgbt = true then 1 else 0 end) as iel1"),
            // DB::raw("sum( CASE WHEN EXTRACT(YEAR FROM (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 AND ins.sexo = 'M' and ins.lgbt = false or EXTRACT(YEAR FROM (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 AND ins.sexo = 'M' and ins.lgbt is null THEN 1  ELSE 0 END ) as iem2"),
            // DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 and ins.sexo='H' and ins.lgbt = false or EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as ieh2"),
            // DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 7 and 11 and ins.lgbt = true then 1 else 0 end) as iel2"),
            // DB::raw("sum( CASE WHEN EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 AND ins.sexo='M' and ins.lgbt = false or EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 AND ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0  END ) as iem3"),
            // DB::raw("sum( Case When EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 and ins.sexo='H' and ins.lgbt = false or EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as ieh3"),
            // DB::raw("sum( Case When EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 12 and 17 and ins.lgbt = true then 1 else 0 end) as iel3"),
            // DB::raw("sum( CASE WHEN EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29  AND ins.sexo='M' and ins.lgbt = false or EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29  AND ins.sexo='M' and ins.lgbt is null THEN 1 ELSE 0 END ) as iem4"),
            // DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29 AND ins.sexo='H' and ins.lgbt = false or EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29 AND ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as ieh4"),
            // DB::raw("sum( case when EXTRACT(year from (age(c.inicio, ins.fecha_nacimiento))) between 18 and 29 AND ins.lgbt = true then 1 else 0 end) as iel4"),
            ...
            // --- RANGO DE ESCOLARIDAD SIN RESTAR LGBT ---
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.sexo='M' then 1 else 0 end) as iesm1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.sexo='H' then 1 else 0 end) as iesh1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.lgbt = true then 1 else 0 end) as iesl1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' then 1 else 0 end) as iesm2"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' then 1 else 0 end) as iesh2"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.lgbt = true then 1 else 0 end) as iesl2"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' then 1 else 0 end) as iesm3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' then 1 else 0 end) as iesh3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.lgbt = true then 1 else 0 end) as iesl3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' then 1 else 0 end) as iesm4"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' then 1 else 0 end) as iesh4"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.lgbt = true then 1 else 0 end) as iesl4"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' then 1 else 0 end) as iesm5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' then 1 else 0 end) as iesh5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.lgbt = true then 1 else 0 end) as iesl5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' then 1 else 0 end) as iesm6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' then 1 else 0 end) as iesh6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.lgbt = true then 1 else 0 end) as iesl6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' then 1 else 0 end) as iesm7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' then 1 else 0 end) as iesh7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.lgbt = true then 1 else 0 end) as iesl7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' then 1 else 0 end) as iesm8"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' then 1 else 0 end) as iesh8"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.lgbt = true then 1 else 0 end) as iesl8"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='M' then 1 else 0 end) as iesm9"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='H' then 1 else 0 end) as iesh9"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.lgbt = true then 1 else 0 end) as iesl9"),

            // --- RANGO DE ESCOLARIDAD RESTANDOLE LGBT ---
            ...
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.lgbt = true then 1 else 0 end) as iesl1"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.lgbt = false or ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as iesm2"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.lgbt = false or ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as iesh2"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.lgbt = true then 1 else 0 end) as iesl2"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.lgbt = false or ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as iesm3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.lgbt = false or ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as iesh3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.lgbt = true then 1 else 0 end) as iesl3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.lgbt = false or ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as iesm4"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.lgbt = false or ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as iesh4"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.lgbt = true then 1 else 0 end) as iesl4"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as iesm5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as iesh5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.lgbt = true then 1 else 0 end) as iesl5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as iesm6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as iesh6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.lgbt = true then 1 else 0 end) as iesl6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as iesm7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as iesh7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.lgbt = true then 1 else 0 end) as iesl7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.lgbt is null then 1 else 0 end) as iesm8"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.lgbt is null then 1 else 0 end) as iesh8"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.lgbt = true then 1 else 0 end) as iesl8"),
            ...
            // --- RANGO DE ACREDITADOS SIN RESTAR LGBT ---
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm2"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh2"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl2"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm4"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh4"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl4"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm8"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh8"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl8"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='M' and ins.calificacion != 'NP' then 1 else 0 end) as aesm9"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='H' and ins.calificacion != 'NP' then 1 else 0 end) as aesh9"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl9"),

            // --- RANGO DE ACREDITADOS RESTANDOLE LGBT ---
            ...
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl1"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesm2"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesh2"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl2"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesm3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesh3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesm4"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesh4"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl4"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesm5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesh5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesm6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesh6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesm7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesh7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesm8"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion != 'NP' and ins.lgbt is null then 1 else 0 end) as aesh8"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion != 'NP' then 1 else 0 end) as aesl8"),
            ...
            // --- RANGO DE NO ACREDITADOS SIN RESTAR LGBT ---
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl1"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm2"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh2"),
            DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl2"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl3"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm4"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh4"),
            DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl4"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl5"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl6"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl7"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm8"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh8"),
            DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl8"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='M' and ins.calificacion = 'NP' then 1 else 0 end) as naesm9"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='H' and ins.calificacion = 'NP' then 1 else 0 end) as naesh9"),
            DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl9"),

            // --- RANGO DE NO ACREDITADOS RESTANDOLE LGBT ---
            ...
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl1"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm2"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='PRIMARIA TERMINADA' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh2"),
            // DB::raw("sum(case when ins.escolaridad='PRIMARIA TERMINADA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl2"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA INCONCLUSA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl3"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm4"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='SECUNDARIA TERMINADA' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh4"),
            // DB::raw("sum(case when ins.escolaridad='SECUNDARIA TERMINADA' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl4"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl5"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL MEDIO SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl6"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR INCONCLUSO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl7"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm8"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh8"),
            // DB::raw("sum(case when ins.escolaridad='NIVEL SUPERIOR TERMINADO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl8"),
            // DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='POSTGRADO' and ins.sexo='M' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesm9"),
            // DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt = false or ins.escolaridad='POSTGRADO' and ins.sexo='H' and ins.calificacion = 'NP' and ins.lgbt is null then 1 else 0 end) as naesh9"),
            // DB::raw("sum(case when ins.escolaridad='POSTGRADO' and ins.lgbt = true and ins.calificacion = 'NP' then 1 else 0 end) as naesl9"),
