...
class ftcontroller extends Controller {
    ...
    protected function xlxExportReporteTbyUnidad(Request $request){
        ...
        $head = [
            'UNIDAD DE CAPACITACION','TIPO DE PLANTEL (UNIDAD, AULA MOVIL, ACCION MOVIL O CAPACITACION EXTERNA)','CAMPO DE FORMACIÓN',
            ...
            'NUMERO DE CONVENIO ESPECIFICO', 'MEMO DE VALIDACION DEL CURSO', 'ESPACIO FISICO', 'NOMBRE DEL INSTRUCTOR','CURP','RFC',
