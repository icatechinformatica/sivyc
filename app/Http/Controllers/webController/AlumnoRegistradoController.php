...
class AlumnoRegistradoController extends Controller
{
    ...
    public function show($id)
    {
        ...
        'alumnos_pre.estado', 'alumnos_pre.estado_civil', 'alumnos_pre.discapacidad', 'alumnos_registro.id', 'alumnos_registro.ultimo_grado_estudios', 'alumnos_registro.empresa_trabaja',
