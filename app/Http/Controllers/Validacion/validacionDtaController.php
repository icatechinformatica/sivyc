...
class validacionDtaController extends Controller {
    ...
    protected function xlsExportReporteFormatotEnlacesUnidad(Request $request) {
        ...
        $head = [
            ...
            'EGRESADOS', 'EGRESADOS FEMENINO', 'EGRESADO MASCULINO', 'DESERCION', 'COSTO TOTAL DEL CURSO POR PERSONA', 'INGRESO TOTAL', 'EXONERACION MUJERES', 'EXONERACION HOMBRES', 'REDUCCION CUOTA MUJERES', 'REDUCCION CUOTA HOMBRES', 'NUMERO DE CONVENIO ESPECIFICO', 'MEMO DE VALIDACION DEL CURSO', 'ESPACIO FISICO',
    ...
    protected function xlsExportReporteFormatoTDirectorDTA(Request $request)
    {
        ...
        $cabecera = [
            'MES REPORTADO', 'UNIDAD DE CAPACITACION', 'TIPO DE PLANTEL (UNIDAD, AULA MOVIL, ACCION MOVIL O CAPACITACION EXTERNA)', 'ESPECIALIDAD', 'CURSO', 'CLAVE DEL GRUPO', 'MODALIDAD', 'DURACION TOTAL EN HORAS', 'TURNO', 'DIA INICIO', 'MES INICIO', 'DIA TERMINO', 'MES TERMINO', 'PERIODO', 'HRS. DIARIAS', 'DIAS', 'HORARIO', 'INSCRITOS', 'FEM', 'MASC', 'LGBTTTI+',
            ...
            'INSCRITOS ESC-5 MUJERES', 'INSCRITOS ESC-5 HOMBRES', 'INSCRITOS ESC-5 LGBTTTI+',
            'INSCRITOS ESC-6 MUJERES', 'INSCRITOS ESC-6 HOMBRES', 'INSCRITOS ESC-6 LGBTTTI+',
            ...
            'DESERTORES ESC-5 MUJERES', 'DESERTORES ESC-5 HOMBRES', 'DESERTORES ESC-5 LGBTTTI+',
            'DESERTORES ESC-6 MUJERES', 'DESERTORES ESC-6 HOMBRES', 'DESERTORES ESC-6 LGBTTTI+',
            'DESERTORES ESC-7 MUJERES', 'DESERTORES ESC-7 HOMBRES', 'DESERTORES ESC-7 LGBTTTI+',
            'DESERTORES ESC-8 MUJERES', 'DESERTORES ESC-8 HOMBRES', 'DESERTORES ESC-8 LGBTTTI+',
