...
class validacionDtaController extends Controller {
    ...
    protected function xlsExportReporteFormatotEnlacesUnidad(Request $request) {
        ...
        $head = [
            ...
            'NOMBRE DEL INSTRUCTOR', 'CURP', 'RFC', 'ESCOLARIDAD DEL INSTRUCTOR', 'DOCUMENTO ADQUIRIDO', 'SEXO', 'MEMO DE VALIDACION', 'MEMO DE AUTORIZACION DE EXONERACION', 'EMPLEADOS', 'DESEMPLEADOS', 'DISCAPACITADOS', 'MIGRANTES','ADOLESCENTES EN CONDICION DE CALLE','MUJERES JEFAS DE FAMILIA',
