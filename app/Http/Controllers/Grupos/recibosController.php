        ...
        if($request->query('folio_recibo')){
            ...
            if($row){
                ...
                if (file_exists(storage_path('app/public/'.$file))) {
                    ...
                    // reemplaza el archivo original por el nuevo archivo
                    //
                    // Mover el archivo
                    // Storage::move($tempOutputPath, $originalFilePath);
                    // checar si el archivo existe
                    if (Storage::disk('public')->exists('temp/'.$originalName)) {
                        # existe
                        rename(dirname('public/temp/'.$originalName), dirname('public/'.$file));
                    } else {
