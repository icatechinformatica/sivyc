...
class EValsupreController extends Controller
{
    public function generar_xml($id_supre){
        ...
        if ($response->json()['cadenaOriginal'] != null) {
            ...
            $dataInsert = DocumentosFirmar::Where('numero_o_clave',$info->clave)->Where('tipo_archivo','valsupre')->WhereIn('status',['CANCELADO','EnFirma'])->First();
        ...
        <div id="wrappertop">
            ...
            <div class="b"> <FONT SIZE=0>UNIDAD DE CAPACITACIÓN '.$data[0]->unidad_capacitacion.'</font><br/>
                ...
                $body_html = $body_html . ' de fecha '.$D.' de '.$M.' del '.$Y.'; me permito comunicarle lo siguiente:<br/></font>
                    <font size=0>La Secretaría de Finanzas mediante oficio N: SF/1228/2025 aprobó el presupuesto del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, para el Ejercicio Fiscal '.$Y.', en ese sentido, con Fundamento en el Art. 13 Y Art. 38 del decreto de presupuesto
