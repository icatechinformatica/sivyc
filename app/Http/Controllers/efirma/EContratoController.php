        ...
        if($data->tipo_curso == 'CURSO')
        {
            if ($data->modinstructor == 'HONORARIOS') {
                ...
                CLÁUSULAS\n
                    ...
                    SEGUNDA.- MONTO. El monto que “ICATECH”, pagará al “PRESTADOR DE SERVICIOS” será por la cantidad de $".$cantidad.' ('.$data_contrato->cantidad_letras1.' '. $monto[1]."/100 M.N.); por curso impartido, mismo que se acumulará y será pagadero mensualmente, menos las retenciones que el “ICATECH” le retendrá como pago provisional por concepto de Impuesto sobre la Renta, de conformidad con lo establecido al artículo 96 de la Ley del Impuesto sobre la Renta, enterando a las Autoridades Hacendarias las retenciones correspondientes.\n
