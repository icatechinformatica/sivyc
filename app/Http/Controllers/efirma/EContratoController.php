...
class EContratoController extends Controller
{
    ...
    public function create_body($id_contrato,$firmantes, $numOficio = NULL) {
        ...
        $data = contratos::SELECT('folios.id_folios','folios.importe_total','tbl_cursos.id','tbl_cursos.horas','tbl_cursos.fecha_apertura','tbl_cursos.soportes_instructor',
                                  ...
                                  'instructores.curp','instructores.sexo','instructores.domicilio','tabla_supre.fecha_validacion')
        ...
        $funcionarios = $this->funcionarios($firmantes->unidad);
        $nombramiento = explode('-', $funcionarios['directorn']);
        $fecha_nombramiento = $nombramiento[2]. ' de '. $this->toMonth($nombramiento[1]). ' del '. $nombramiento[0];
        ...
        if ($data->modinstructor == 'HONORARIOS') {
            ...
            'CONTRATO DE PRESTACIÓN DE SERVICIOS PROFESIONALES POR HONORARIOS EN SU MODALIDAD DE HORAS CURSO, QUE CELEBRAN POR UNA PARTE, EL INSTITUTO DE CAPACITACIÓN Y VINCULACIÓN TECNOLÓGICA DEL ESTADO DE CHIAPAS, REPRESENTADO POR ';
            if($funcionarios['directors'] == 'MASCULINO') {
                $body = $body . 'EL';
            } else {
                $body = $body . 'LA';
            }
            $body = $body . $firmantes->dunidad .','.' EN SU CARÁCTER DE '. $firmantes->pdunidad . ' '. $data_contrato->unidad_capacitacion .' Y POR LA OTRA LA O EL C. '.$nomins.", EN SU CARÁCTER DE INSTRUCTOR EXTERNO; A QUIENES EN LO SUCESIVO SE LES DENOMINARÁ “ICATECH” Y “PRESTADOR DE SERVICIOS” RESPECTIVAMENTE; MISMO QUE SE FORMALIZA AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES: \n
            DECLARACIONES \n
            ...
            if(is_null($numOficio)) {
             ...
             $body_html = $body_html.'<br><div align="justify"><b>CONTRATO DE PRESTACIÓN DE SERVICIOS PROFESIONALES MODALIDAD DE '.($data->tipo_curso == 'CURSO' ? 'HORAS CURSO' : 'CERTIFICACION EXTRAORDINARIA').', QUE CELEBRAN POR UNA PARTE, EL INSTITUTO DE CAPACITACIÓN Y VINCULACIÓN TECNOLÓGICA DEL ESTADO DE CHIAPAS, REPRESENTADO POR '. $funcionarios['director'].', EN SU CARÁCTER DE '. $funcionarios['directorp'].' Y POR LA OTRA '. $nomins. ', EN SU CARÁCTER DE INSTRUCTOR EXTERNO; A QUIENES EN LO SUCESIVO SE LES DENOMINARÁ “ICATECH” Y “PRESTADOR DE SERVICIOS” RESPECTIVAMENTE; MISMO QUE SE FORMALIZA AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES:</b></div>
            <br><div align="center"> DECLARACIONES</div>
            <div align="justify">
                <dl>
                    <dt>I.  <b>“ICATECH”</b> declara que:<br>
                    <br><dd>I.1 Es un Organismo Descentralizado de la Administración Pública Estatal, con personalidad jurídica y patrimonio propio, conforme al Decreto de Creación número 182, publicado en el Periódico Oficial del Estado número 032, de fecha 26 de julio del año 2000, y del Decreto número 183 por el que se reforman, derogan y adicionan diversas disposiciones del Decreto por el que se creó el Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, publicado en el Periódico Oficial del Estado número 094, de fecha 21 de mayo del año 2008, así mismo del Decreto número 031 por el que reforman y abrogan diversas Leyes y Decretos por los que se crean diversos Organismos Públicos del Poder Ejecutivo del Estado, publicado en el Periódico Oficial número 006, tomo III, de fecha 31 de diciembre de 2018 y del Decreto número 180, publicado en el Periódico Oficial número 148, de fecha 20 de enero del año 2021.</dd>
                    ...
                    <br><dd>I.3 '. $funcionarios['director'].', '.$funcionarios['directorp'].', tiene personalidad jurídica para representar en este acto a <b>“ICATECH”</b>, como lo acredita con el nombramiento expedido por el Titular de la Dirección General del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, de fecha '. $fecha_nombramiento.', y cuenta con plena facultad legal para suscribir el presente Instrumento conforme a lo dispuesto por los artículos 42 fracción I del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas y 12 fracción V, de los Lineamientos para los Procesos de Vinculación y Capacitación del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas.</dd>
                    ...
                    <br><dd>I.8 Para los efectos del presente Contrato señala como su domicilio legal, el ubicado en ' . $direccion_instituto . '</dd>
                </dl>
                <dl><dt>II. <b>"PRESTADOR DE SERVICIOS"</b> declara que:</dt>
                    <br><dd>II.1 '. $nomins. ', es una persona física, de nacionalidad mexicana, que acredita mediante '. ($tipo_identificacion == 'INE' ? 'credencial para votar' : $tipo_identificacion).' con número de folio '.$folio_identificacion. ', con plena capacidad jurídica y facultades que le otorga la ley, para contratar y obligarse, así como también con los estudios, conocimientos y la experiencia necesaria en la materia de '. $data->espe. ' y conoce plenamente las necesidades de los servicios objeto del presente contrato, así como que ha considerado todos los factores que intervienen para desarrollar eficazmente las actividades que desempeñará.</dd>
                    <br><dd>II.2 Se encuentra al corriente en el pago de sus impuestos y cuenta con el Registro Federal de Contribuyentes número '. $data->rfc. ', expedido por el Servicio de Administración Tributaria, conforme a lo dispuesto por los artículos 27 del Código Fiscal de la Federación y 110 fracción I de la Ley de Impuesto sobre la Renta.</dd>
            ...
            <br><div align="justify">
                ...
                <br><dd>
                    I. &nbsp;&nbsp;Diseñar, preparar e impartir '.($data->tipo_curso == 'CURSO' ? 'el curso' : 'la certificación extraordinaria').' a su cargo con toda la diligencia y esmero que exige la calidad de <b>“ICATECH”</b>.</li>
                    <br><br>II. &nbsp;Vigilar que su '.($data->tipo_curso == 'CURSO' ? 'curso impartido' : 'certificación extraordinaria').' se aproveche íntegramente el tiempo necesario para el mejor desarrollo del mismo.</li>
                    <br><br>III. Realizar la comprobación final '.($data->tipo_curso == 'CURSO' ? 'del curso impartido' : 'de la certificación extraordinaria').'.</>
                    <br><br>IV. Respetar las normas de conducta.</li>
                    <br><br>V. &nbsp;Implementar el Lenguaje Incluyente en la impartición '.($data->tipo_curso == 'CURSO' ? 'del curso' : 'de la certificación extraordinaria').'.</li>
                </dd>
            </div>
            <br>
            <div align="justify">
            ...
            <br><dd>
                ...
                <br><br>II. &nbsp;&nbsp;&nbsp;Falta de probidad u honradez.
                <br><br>III. &nbsp;&nbsp;Por prestar los servicios de forma ineficiente e inoportuna.
                <br><br>IV. &nbsp;&nbsp;Por no apegarse a lo estipulado en el presente contrato.
                <br><br>V. &nbsp;&nbsp;&nbsp;Por no observar la discreción debida respecto a la información a la que tenga acceso como consecuencia de la información de los servicios encomendados.
                <br><br>VI. &nbsp;&nbsp;Por suspender injustificadamente la prestación de los servicios o por negarse a corregir lo rechazado por <b>“ICATECH”</b>.
                <br><br>VII. &nbsp;Por negarse a informar a <b>“ICATECH”</b> sobre los resultados de la prestación del servicio encomendado.
                <br><br>VIII. Por impedir el desempeño normal de las labores durante la prestación de los servicios.
                <br><br>IX. &nbsp;&nbsp;Si se comprueba que la protesta a que se refiere la Declaración II.4 de <b>“PRESTADOR DE SERVICIOS”</b> se realizó con falsedad.
                <br><br>X. &nbsp;&nbsp;&nbsp;Por no otorgar '.($data->tipo_curso == 'CURSO' ? 'el curso' : 'la certificación extraordinaria').' en el tiempo establecido.
            </dd>
            <br>
    ...
    public function funcionarios($unidad) {
        $query = clone $direc = clone $ccp1 = clone $ccp2 = clone $delegado = clone $academico = clone $vinculacion = clone $destino = clone $directorDTA = DB::Table('tbl_organismos AS o')->Select('f.nombre','f.cargo','f.incapacidad','f.sexo','f.titulo','f.fecha_nombramiento')
        ...
        $funcionarios = [
            ...
            'directorn' => $direc->fecha_nombramiento,
