...
class convenioAvailable extends Model
{
    //
    protected $table = 'convenios_available';

    protected $fillable = [
        'id','convenio_id','CHK_TUXTLA','CHK_TAPACHULA','CHK_COMITAN','CHK_REFORMA','CHK_TONALA','CHK_VILLAFLORES',
        ...
        'CHK_PICHUCALCO','CHK_JUAREZ','CHK_SIMOJOVEL','CHK_MAPASTEPEC','CHK_VILLA_CORZO','CHK_CACAHOTAN',
