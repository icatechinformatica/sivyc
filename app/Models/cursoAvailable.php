...
class cursoAvailable extends Model
{
    //
    protected $table = 'cursos_available';

    protected $fillable = [
        'id','curso_id','CHK_TUXTLA','CHK_TAPACHULA','CHK_COMITAN','CHK_REFORMA','CHK_TONALA','CHK_VILLAFLORES',
