...
class Instructor extends Model
{
    ...
    protected $fillable = [
        'id', 'numero_control', 'nombre', 'apellidoPaterno', 'apellidoMaterno', 'experiencia_laboral',
        'experiencia_docente', 'cursos_recibidos', 'capacitados_icatech', 'curso_recibido_icatech',
