...
Route::middleware(['auth'])->group(function(){        
    ...
    Route::post('/consultas/contratosfirmados', 'Consultas\contratosfirmadosController@index')->name('consultas.contratosfirmados')->middleware('can:consultas.contratosfirmados');
