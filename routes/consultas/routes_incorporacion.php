...
Route::middleware(['auth'])->group(function(){        
    ...
    Route::post('consultas/bolsa/alumnos', 'Consultas\BolsaTrabController@index')->name('consultas.bolsa.index');    
    ...
    Route::post('consultas/bolsa/guardar', 'Consultas\BolsaTrabController@guardar')->name('consultas.bolsa.guardar'); //Post para datos de incorporación
