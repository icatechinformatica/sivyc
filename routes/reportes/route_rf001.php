...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/reportes/rf001/ingreso-propio', [Rf001Controller::class, 'index'])->middleware('permission:Solicitud RF001')->name('reporte.rf001.ingreso-propio');
    Route::post('/reportes/rf001/generar', [Rf001Controller::class, 'store'])->name('reporte.rf001.store');
    Route::get('/reportes/rf001/generados', [Rf001Controller::class, 'getSentFormat'])->middleware(['permission:Solicitud RF001|Visto Bueno RF001'])->name('reporte.rf001.sent');
