...
Route::middleware(['auth'])->group(function(){    
    ...
    Route::post('/reportes/dv', 'reportesController\dvController@index')->middleware('can:reportes.dv');
    ...
    Route::post('/reportes/dv/generar', 'reportesController\dvController@generar')->middleware('can:reportes.dv');    
});