...
Route::middleware(['auth'])->group(function(){    
    ...
    Route::post('/reportes/pat', 'reportesController\patController@index')->middleware('can:reportes.pat');
    ...
    Route::post('/reportes/pat/generar', 'reportesController\patController@generar')->middleware('can:reportes.pat');    
});