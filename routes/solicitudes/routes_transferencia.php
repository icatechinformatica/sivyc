...
Route::middleware(['auth'])->group(function(){    
    ...
    Route::post('/solicitudes/transferencia/index', 'Solicitudes\transferenciaController@index')->middleware('can:solicitudes.transferencia');
    ...
    Route::post('/solicitudes/transferencia/marcar', 'Solicitudes\transferenciaController@marcar')->middleware('can:solicitudes.transferencia');
    ...
    Route::post('/solicitudes/transferencia/deshacer', 'Solicitudes\transferenciaController@deshacer')->middleware('can:solicitudes.deshacer');
    ...
    Route::post('/solicitudes/transferencia/pagado', 'Solicitudes\transferenciaController@pagado')->middleware('can:solicitudes.transferencia');
