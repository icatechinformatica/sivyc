...
Route::middleware(['auth'])->group(function(){
    ...
    Route::post('/solicitudes/vbgrupos', 'Solicitudes\vbgruposController@index')->middleware('can:solicitudes.vb.grupos');
    ...
    Route::post('/solicitudes/vbgrupos/vistobueno', 'Solicitudes\vbgruposController@vistobueno')->middleware('can:solicitudes.vb.grupos');
