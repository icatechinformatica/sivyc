...
Route::middleware(['auth'])->group(function(){
    ...
    Route::post('/grupos/recibos/buscar', 'Grupos\recibosController@buscar')->middleware('can:grupos.recibos');

    Route::get('/grupos/recibos/index', 'Grupos\recibosController@index')->name('grupos.recibos')->middleware('can:grupos.recibos');
    Route::post('/grupos/recibos/index', 'Grupos\recibosController@index')->middleware('can:grupos.recibos');
    ...
    Route::post('/grupos/recibos/pdf', 'Grupos\recibosController@pdfRecibo');
    Route::get('/grupos/recibo/descargar', 'Grupos\recibosController@pdfDescargar')->name('grupos.recibos.descargar');
    Route::post('/grupos/recibo/descargar', 'Grupos\recibosController@pdfDescargar');
});
