...
class CreateInstructorAvailableTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('instructor_available', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('instructor_available');
    }
}
