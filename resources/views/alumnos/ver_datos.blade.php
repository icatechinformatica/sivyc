                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->date('fecha_documento_curp')->class('form-control')->id('fecha_documento_curp')->attribute('aria-label', 'Fecha de Expedición CURP')->attribute('aria-describedby', 'fecha-curp-addon')->value(
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->text('primer_apellido')->class('form-control')->id('primer_apellido')->attribute('aria-label', 'Primer Apellido')->attribute('aria-describedby', 'primer-apellido-addon')->value(!$esNuevoRegistro ? $datos->apellido_paterno : '') !!}
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->text('segundo_apellido')->class('form-control')->id('segundo_apellido')->attribute('aria-label', 'Segundo Apellido')->attribute('aria-describedby', 'segundo-apellido-addon')->value(!$esNuevoRegistro ? $datos->apellido_materno : '') !!}
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select(
                                        ...
                                        )->class('form-control')->id('entidad_de_nacimiento_select')->attribute('aria-label', 'Entidad de Nacimiento')->attribute('aria-describedby', 'entidad-addon')->value(!$esNuevoRegistro ? $datos->entidad_de_nacimiento : '') !!}
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->text('fecha_de_nacimiento')->class('form-control')->id('fecha_de_nacimiento')->attribute('aria-label', 'Fecha de Nacimiento')->attribute('aria-describedby', 'fecha-addon')->value(!$esNuevoRegistro ? $datos->fecha_nacimiento : '') !!}
                                </div>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select('sexo_select', [null => 'SELECCIONE EL SEXO'] + $sexos->pluck('sexo', 'id')->toArray())->class('form-control')->id('sexo_select')->attribute('aria-label', 'Sexo')->attribute('aria-describedby', 'sexo-addon')->value(!$esNuevoRegistro ? $datos->sexo->id : '') !!}
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select(
                                            'nacionalidad_select',
                                            [null => 'SELECCIONE LA NACIONALIDAD'] + $nacionalidades->pluck('nacionalidad', 'id_nacionalidad')->toArray(),
                                        )->class('form-control')->id('nacionalidad_select')->attribute('aria-label', 'Nacionalidad')->attribute('aria-describedby', 'nacionalidad-addon')->value(!$esNuevoRegistro ? $datos->nacionalidad->id_nacionalidad : '') !!}
                                    {!! html()->text('nacionalidad_input')->id('nacionalidad_input')->class('form-control')->value(!$esNuevoRegistro ? $datos->nacionalidad->nacionalidad : '') !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                    ...
                    <div class="p-3 mb-2">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="pais-addon"><i
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select('estado_select', [null => 'SELECCIONE EL ESTADO'] + $estados->pluck('nombre', 'id')->toArray())->class('form-control')->id('estado_select')->attribute('aria-label', 'Estado')->attribute('aria-describedby', 'estado-addon')->value(!$esNuevoRegistro && $datos->estado ? $datos->estado->id : '') !!}
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select('municipio_select', [null => 'SELECCIONE EL MUNICIPIO'] + $municipios->pluck('muni', 'id')->toArray())->class('form-control')->id('municipio_select')->attribute('aria-label', 'Municipio')->attribute('aria-describedby', 'municipio-addon')->value(!$esNuevoRegistro && $datos->municipio ? $datos->municipio->id : '') !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="localidad-addon"><i
                                                class="bi bi-geo"></i></span>
                                    </div>
                                    {!! html()->text('localidad')->class('form-control')->id('localidad')->attribute('aria-label', 'Localidad')->attribute('aria-describedby', 'localidad-addon')->value($esNuevoRegistro ? '' : $datos->clave_localidad) !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="cp-addon"><i
                                                class="bi bi-mailbox"></i></span>
                                    </div>
                                    {!! html()->text('codigo_postal')->class('form-control')->id('codigo_postal')->attribute('aria-label', 'Código Postal')->attribute('aria-describedby', 'cp-addon')->value($esNuevoRegistro ? '' : $datos->cp) !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->text('domicilio')->class('form-control')->id('domicilio')->attribute('aria-label', 'Domicilio')->attribute('aria-describedby', 'domicilio-addon')->value($esNuevoRegistro ? '' : $datos->domicilio) !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->text('colonia')->class('form-control')->id('colonia')->attribute('aria-label', 'Colonia')->attribute('aria-describedby', 'colonia-addon')->value($esNuevoRegistro ? '' : $datos->colonia) !!}
                                </div>
                            </div>
                            <div class="col-md-12 d-flex justify-content-end">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->number('telefono_casa')->class('form-control')->id('telefono_casa')->attribute('aria-label', 'Teléfono Casa')->attribute('aria-describedby', 'tel-casa-addon')->attribute('maxlength', '10')->value($esNuevoRegistro ? '' : $datos->telefono_casa) !!}
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="tel-cel-addon"><i
                                                class="bi bi-phone"></i></span>
                                    </div>
                                    {!! html()->number('telefono_celular')->class('form-control')->id('telefono_celular')->attribute('aria-label', 'Teléfono Celular')->attribute('aria-describedby', 'tel-cel-addon')->attribute('maxlength', '10')->value($esNuevoRegistro ? '' : $datos->telefono_celular) !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->email('correo_electronico')->class('form-control')->id('correo_electronico')->attribute('aria-label', 'Correo Electrónico')->attribute('aria-describedby', 'correo-addon')->value($esNuevoRegistro ? '' : $datos->correo) !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->text('facebook')->class('form-control')->id('facebook')->attribute('aria-label', 'Facebook')->attribute('aria-describedby', 'facebook-addon')->value($esNuevoRegistro ? '' : $datos->facebook) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3 d-flex align-items-center"
                                    ...
                                    {!! html()->label('¿Usted autoriza dar su número de celular para alguna oportunidad en la Bolsa de Trabajo?')->for('autoriza_bolsa_trabajo')->class('fw-bold me-3 mb-0')->style('color: #ad8b00; font-size: 1.1em;') !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-check my-4 border-bottom pb-4">
                                    {!! html()->checkbox('pertenece_a_grupo_vulnerable')->class('form-check-input')->id('pertenece_a_grupo_vulnerable')->checked($esNuevoRegistro ? false : !$datos->vulnerable && empty($gruposVulnerablesSeleccionados)) !!}
                                ...
                                <div class="col-md-4">
                                    @foreach ($chunk as $grupo)
                                        <div class="form-check my-4">
                                            {!! html()->checkbox('grupos_vulnerables[]')->value($grupo->id_grupo_vulnerable)->class('form-check-input')->id('grupo_vulnerable_' . $grupo->id_grupo_vulnerable)->checked(in_array($grupo->id_grupo_vulnerable, $gruposVulnerablesSeleccionados)) !!}
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select(
                                            ...
                                            ['' => 'SELECCIONE EL GRADO'] + $gradoEstudios->pluck('grado_estudio', 'id_grado_estudio')->toArray(),
                                        )->class('form-control')->id('ultimo_grado_estudios')->attribute('aria-label', 'Ultimo Grado de Estudios')->attribute('aria-describedby', 'grado-estudios-addon')->value(!$esNuevoRegistro && $datos->gradoEstudio ? $datos->gradoEstudio->id_grado_estudio : '') !!}
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->date('fecha_documento_ultimo_grado')->class('form-control')->id('fecha_documento_ultimo_grado')->attribute('aria-label', 'Fecha del Documento')->attribute('aria-describedby', 'fecha-documento-addon')->value(
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select('medio_enterado_sistema', [
                                            ...
                                            6 => 'OTROS',
                                        ])->class('form-control')->id('medio_enterado_sistema')->attribute('aria-label', 'Medio por el que se enteró del sistema')->attribute('aria-describedby', 'medio-enterado-addon')->value(!$esNuevoRegistro && !empty($datos->medio_entero) ? $datos->medio_entero : '') !!}
                                </div>
                            </div>
                            <div class="col-md-9 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select('motivo_eleccion_capacitacion', [
                                            ...
                                            7 => 'OTRO',
                                        ])->class('form-control')->id('motivo_eleccion_capacitacion')->attribute('aria-label', 'Motivos de elección del sistema de capacitación')->attribute('aria-describedby', 'motivo-eleccion-addon')->value(
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    {!! html()->select('medio_confirmacion', [
                                            ...
                                            6 => 'X (Antes Twitter)',
                                            7 => 'TELEGRAM',
                                        ])->class('form-control')->id('medio_confirmacion')->attribute('aria-label', 'Medio de confirmación')->attribute('aria-describedby', 'medio-confirmacion-addon')->value(!$esNuevoRegistro && !empty($datos->medio_confirmacion) ? $datos->medio_confirmacion : '') !!}
                                </div>
                            </div>
                            <div class="col-md-12 d-flex justify-content-end">
                    ...
                    <div class="p-3 mb-2">
                        ...
                        <div class="row mt-3 d-none" id="datos-empleo">
                            <div class="col-md-4 mb-3">
                                ...
                                {!! html()->text('empresa_trabaja')->class('form-control')->id('empresa_trabaja')->placeholder('Nombre de la empresa')->value($esNuevoRegistro ? '' : $datos->empresa_trabaja) !!}
                            </div>
                            <div class="col-md-4 mb-3">
                                {!! html()->label('Puesto')->for('puesto_trabajo') !!}
                                {!! html()->text('puesto_trabajo')->class('form-control')->id('puesto_trabajo')->placeholder('Puesto que desempeña')->value($esNuevoRegistro ? '' : $datos->puesto_empresa) !!}
                            </div>
                            <div class="col-md-2 mb-3">
                                {!! html()->label('Antigüedad')->for('antiguedad_trabajo') !!}
                                {!! html()->text('antiguedad_trabajo')->class('form-control')->id('antiguedad_trabajo')->placeholder('Años/Meses')->value($esNuevoRegistro ? '' : $datos->antiguedad) !!}
                            </div>
                            <div class="col-md-6 mb-3">
                                {!! html()->label('Dirección de la empresa')->for('direccion_trabajo') !!}
                                {!! html()->text('direccion_trabajo')->class('form-control')->id('direccion_trabajo')->placeholder('Dirección completa')->value($esNuevoRegistro ? '' : $datos->direccion_empresa) !!}
                            </div>
                        </div>
                        <div class="col-md-12 d-flex justify-content-end">
                    ...
                    <div class="p-3 mb-2">
                        ...
                        <div class="row mt-3" id="datos-cerss">
                            <div class="col-md-6 mb-3">
                                ...
                                {!! html()->text('numero_expediente')->class('form-control')->id('numero_expediente')->placeholder('Número de expediente')->value(!$esNuevoRegistro && !empty($datosCerss['numero_expediente']) ? $datosCerss['numero_expediente'] : '') !!}
                            </div>
                            <div class="col-md-6 mb-3">
