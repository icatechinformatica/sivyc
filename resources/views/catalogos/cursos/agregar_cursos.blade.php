        ...
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3">
             ...
             <div class="col-md-2 mb-3">
                <label for="unidad_accion_movil">UNIDAD</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="unidad-addon">
            ...
            <div class="col-md-2 mb-3">
                <label for="areaCursos">CAMPO</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="campo-addon">
                            <i class="fa fa-university"></i>
                        </span>
                    </div>
