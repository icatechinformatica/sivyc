...
<head>
    ...
    <body>
        ...
        <div class= "container g-pt-30" style="font-size: 12px;">
            <div id="content">
                <div align=right> <b>Contrato No. @no_contrato</b> </div>
                <br><div align="justify"><b>CONTRATO DE PRESTACIÓN DE SERVICIOS PROFESIONALES POR HONORARIOS EN SU MODALIDAD DE HORAS CURSO, QUE CELEBRAN POR UNA PARTE, EL INSTITUTO DE CAPACITACIÓN Y VINCULACIÓN TECNOLÓGICA DEL ESTADO DE CHIAPAS, REPRESENTADO POR @titular_uc, EN SU CARÁCTER DE @cargo_titular_uc Y POR LA OTRA LA O EL C. @instructor, EN SU CARÁCTER DE INSTRUCTOR EXTERNO; A QUIENES EN LO SUCESIVO SE LES DENOMINARÁ “ICATECH” Y “PRESTADOR DE SERVICIOS” RESPECTIVAMENTE; MISMO QUE SE FORMALIZA AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES:</b></div>
                ...
                <div align="justify">
                    <dl>
                        ...
                        <br><dd>I.5 De acuerdo a las necesidades de <b>“ICATECH”</b>, se requiere contar con los servicios de una persona física con conocimientos en @espe_instructor, por lo que se ha determinado llevar a cabo la Contratación bajo el regimen de <b>@regimen_instructor</b> en la modalidad de horas curso como <b>"PRESTADOR DE SERVICIOS"</b>.</dd>
                        <br><dd>I.6 Para los efectos del presente contrato se cuenta con la clave de grupo No: @clave_grupo, así como la validación del instructor emitido por la Dirección Técnica Académica de <b>“ICATECH”</b> conforme a lo dispuesto por el artículo 4 fracción III de los Lineamientos para los Procesos de Vinculación y Capacitación del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, emitido por la Dirección Técnica Académica de <b>“ICATECH”</b>.</dd>
                        ...
                        <br><dd>I.8 Para los efectos del presente Contrato señala como su domicilio legal, el ubicado en la Av. Barrio San Jacinto N° 154, entre calle Pájaros y calle Conejos, Fracc. El Diamante C.P. 29059, en la Ciudad de Tuxtla Gutiérrez, Chiapas.</dd>
                    </dl>
                    <dl><dt>II. <b>"PRESTADOR DE SERVICIOS"</b> declara que:</dt>
                        <br><dd>II.1 Es una persona física, de nacionalidad Mexicana, que acredita mediante @tipo_identif_instructor con número de folio @folio_identif_instructor, con plena capacidad jurídica y facultades que le otorga la ley, para contratar y obligarse, así como también con los estudios, conocimientos y la experiencia necesaria en la materia de @espe_instructor y conoce plenamente las necesidades de los servicios objeto del presente contrato, así como que ha considerado todos los factores que intervienen para desarrollar eficazmente las actividades que desempeñará.</dd>
                        <br><dd>II.2 Se encuentra al corriente en el pago de sus impuestos y cuenta con el Registro Federal de Contribuyentes número @rfc_instructor, expedido por el Servicio de Administración Tributaria de la Secretaría de Hacienda y Crédito Público, conforme a lo dispuesto por los artículos 27 del Código Fiscal de la Federación y 110 fracción I de la Ley de Impuesto sobre la Renta.</dd>
                        ...
                        <br><dd>II.5 Para los efectos del presente contrato, señala como su domicilio legal el ubicado en @domicilio_instructor.</dd>
                    </dl>
                </div>
                ...
                <br><div align="justify">
                    <dd><b>PRIMERA.- OBJETO DEL CONTRATO</b>. El presente instrumento tiene por objeto establecer al <b>“PRESTADOR DE SERVICIOS”</b> los términos y condiciones que se obliga con <b>“ICATECH”</b>, a brindar sus servicios profesionales bajo el régimen de <b>@regimen_instructor,</b> para otorgar el curso establecido en el ARC01 y/o ARC02.</dd>
                    <br><dd><b>SEGUNDA.- MONTO</b>. El monto que <b>“ICATECH”</b>, pagará al <b>“PRESTADOR DE SERVICIOS”</b> será por la cantidad de <b>$@importe_monto (@importe_monto_letra @monto/100 M.N.)</b>, por curso impartido, menos las retenciones que el <b>“ICATECH”</b> le realizará como pago provisional por concepto de Impuesto sobre la Renta, de conformidad con lo establecido al articulo 96 de la Ley del Impuesto Sobre la Renta, enterando a las Autoridades Hacendarias las retenciones correspondientes.</dd>
                    ...
                    <Ol type = "I">
                        <li> Diseñar, preparar e impartir los cursos a su cargo con toda la diligencia y esmero que exige la calidad de <b>“ICATECH”</b>.</li>
                ...
                <div align="justify"><dd>Asimismo; en caso de tener evidencias de que el curso no fue impartido, se procederá a dar por rescindido el contrato, y se interpondrá la acción legal que corresponda.</dd>
                    ...
                    <br><dd>Leído que fue el presente contrato a las partes que en él intervienen y una vez enterados de su contenido y alcance legal, son conformes con los términos del mismo y lo suscriben el día de su inicio y ratifican para constancia en el Municipio de @municipio, Chiapas.</dd>
                </div>
                {{-- firmantes --}}
                @firmantes
            </div>
