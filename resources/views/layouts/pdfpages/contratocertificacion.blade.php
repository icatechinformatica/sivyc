            ...
            <div id="content">
                ...
                <div align="justify">
                    <dl>
                        ...
                        <br><dd>I.3 Con fundamento en el artículo 13 fracción IV del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, la Mtra. Fabiola Lizbeth Astudillo Reyes, en su carácter de Directora General, tiene como atribución delegable la de celebrar y suscribir convenios, acuerdos, contratos y demás actos de carácter administrativo de conformidad con las actividades de <b>“EL ICATECH”</b>. En ese sentido, tuvo a bien designar mediante el articulo 43 del capitulo II de las firmas de contratos de los lineamientos de los tramites de pagos a instructores e ingresos propios publicado en el periódico oficial por el organo de difusión oficial del estado libre y soberano de Chiapas con fecha del 27 de enero del 2021, y conforme a lo dispuesto por el artículo 29 fracción I, III y XI del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, al (a la) C. {{$director->nombre}} {{$director->apellidoPaterno}} {{$director->apellidoMaterno}}, {{$director->puesto}} DE CAPACITACIÓN {{$data_contrato->unidad_capacitacion}}, para suscribir el presente acuerdo de voluntades.</dd>
