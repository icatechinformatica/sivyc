            ...
            <div id="content">
                ...
                <div align="justify">
                    <dl>
                        ...
                        <br><dd>I.6 De acuerdo a las necesidades de <b>“EL ICATECH”</b>, se requiere contar con los servicios de una persona física con conocimientos en {{$especialidad->nombre}}, por lo que se ha determinado llevar a cabo la Contratación por Honorarios en la modalidad de horas de certificación de <b>"EL PRESTADOR DE SERVICIOS"</b>.</dd>
                    ...
                    <br><dl><dt>II.Declara <b>"EL PRESTADOR DE SERVICIOS"</b> que:</dt>
                        <br><dd>II.1 Es una persona física, de nacionalidad Mexicana, lo cual acredita mediante @if($data->tipo_identificacion == 'INE')Credencial Para Votar @else{{$data->tipo_identificacion}}@endif con número de folio {{$data->folio_ine}}, por lo que cuenta con los conocimientos necesarios de certificación extraordinaria de cursos.</dd>
