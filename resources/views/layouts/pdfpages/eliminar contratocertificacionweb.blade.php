    ...
    <body>
        ...
        <div class= "container g-pt-30" style="font-size: 12px;">
            <div id="content">
                ...
                <br><div align="justify"><b>CONTRATO DE PRESTACIÓN DE SERVICIOS PROFESIONALES POR HONORARIOS EN SU MODALIDAD DE CERTIFICACION EXTRAORDINARIA, QUE CELEBRAN POR UNA PARTE, EL INSTITUTO DE CAPACITACIÓN Y VINCULACIÓN TECNOLÓGICA DEL ESTADO DE CHIAPAS, REPRESENTADO POR EL (LA) C. <a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">{{$director->nombre}} {{$director->apellidoPaterno}} {{$director->apellidoMaterno}}</a>, EN SU CARÁCTER DE <a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">{{$director->puesto}} DE LA UNIDAD DE CAPACITACIÓN {{$data_contrato->unidad_capacitacion}}</a> Y POR LA OTRA (EL) (LA) C. <a data-target="#instructorModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#instructorModal">{{$nomins}}</a>, EN SU CARÁCTER DE INSTRUCTOR EXTERNO; A QUIENES EN LO SUCESIVO SE LES DENOMINARÁ “EL ICATECH” Y “EL PRESTADOR DE SERVICIOS” RESPECTIVAMENTE; MISMO QUE SE FORMALIZA AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES:</b></div>
                <br><div align="center"> DECLARACIONES</div>
                <div align="justify">
                    <dl>
                        <dt>I.Declara <b>“EL ICATECH”</b> que:<br>
                        <br><dd>I.1 Es un Organismo Descentralizado de la Administración Pública Estatal, con personalidad jurídica y patrimonio propio, conforme lo dispuesto en el artículo 1 del Decreto de Creación número 182, publicado en el Periódico Oficial número 032, de fecha 26 de Julio del año 2000 y del Decreto número 183 por el que se Reforman, Derogan y Adicionan diversas disposiciones del Decreto por el que se crea el Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, publicado en el Periódico Oficial número 094 de fecha 21 de mayo del año 2008, así mismo del Decreto número 031 por el que reforman y abrogan diversas Leyes y Decretos por los que se Crean Diversos Organismos Públicos del Poder Ejecutivo del Estado, publicado en el Periódico Oficial número 006, tomo III, de fecha 31 de diciembre de 2018 y del Decreto número 180, publicado en el Periódico Oficial número 148, de fecha 20 de enero del año 2021.</dd>
                        <br><dd>I.2 El Lcdo. Gerardo Jimenéz Villalobos, en su carácter de Encargado de la Dirección General del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas personalidad que se acredita con nombramiento expedido a su favor por el Dr. Rutilio Escandón Cadenas, Gobernador del Estado de Chiapas, de fecha 16 de enero de 2019, por lo que se encuentra plenamente facultada en términos de lo dispuesto en los artículos 28 fracción I de la Ley de Entidades Paraestatales del Estado de Chiapas; 15 fracción I del Decreto por el que se crea el Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, así como el 13 fracción IV del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, mismas que no le han sido limitadas o revocadas en forma alguna.</dd>
                        <br><dd>I.3 Con fundamento en el artículo 13 fracción IV del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, El Lcdo. Gerardo Jimenéz Villalobos, en su carácter de Encargado de la Dirección General del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, tiene como atribución delegable la de celebrar y suscribir convenios, acuerdos, contratos y demás actos de carácter administrativo de conformidad con las actividades de <b>“EL ICATECH”</b>. En ese sentido, tuvo a bien designar mediante el Artículo 43 del Capítulo II De las Firmas Contratos del Título Séptimo De los Trámites de Contratación, Pagos instructores e Ingresos Propios de los lineamientos de Capacitación y Vinculación del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas publicado en el Periódico Oficial No.149, por el Órgano de Difusión de Estado Libre y Soberano de Chiapas con fecha 27 de enero del 2021, y conforme a lo dispuesto por el artículo 29 fracción I, III y XI del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, al (a la) C. <a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">{{$director->nombre}} {{$director->apellidoPaterno}} {{$director->apellidoMaterno}}, {{$director->puesto}} DE CAPACITACIÓN {{$data_contrato->unidad_capacitacion}}</a>, para suscribir el presente acuerdo de voluntades.</dd>
                        ...
                        <br><dd>I.5  Cuando en este contrato de prestación de servicios se utilice el genérico masculino por efectos gramaticales, deberá entenderse que se hace referencia a mujeres y a hombres por igual.</b>.</dd>
                        <br><dd>I.6 De acuerdo a las necesidades de <b>“EL ICATECH”</b>, se requiere contar con los servicios de una persona física con conocimientos en <a data-target="#instructorModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#instructorModal">{{$especialidad->nombre}}</a>, por lo que se ha determinado llevar a cabo la Contratación por Honorarios en la modalidad de horas de certificación de <b>"EL PRESTADOR DE SERVICIOS"</b>.</dd>
                        <br><dd>I.7 Para los efectos del presente contrato se cuenta con el Dictamen de autorización de habilidades como instructor según memorándum que se agrega al presente instrumento como <b>Anexo I</b>, emitido por la Dirección Técnica Académica de <b>“EL ICATECH”</b>.</dd>
                        <br><dd>I.8 Para los efectos del presente contrato se cuenta con la clave de grupo que se agrega al presente instrumento como <b>Anexo II</b>, emitido por la Dirección Técnica Académica de <b>“EL ICATECH”</b>.</dd>
                        <br><dd>I.9 Para los efectos del presente contrato se cuenta con la suficiencia presupuestal, conforme al presupuesto de egresos autorizado, que se agrega al presente instrumento como <b>Anexo III</b>, emitido por la Dirección de Planeación de <b>“EL ICATECH”</b>.</dd>
                        <br><dd>I.10 Para los efectos del presente Contrato señala como su domicilio legal, el ubicado en la Av. Barrio San Jacinto N° 154, entre calle Pájaros y calle Conejos, Fracc. El Diamante C.P. 29059, en la Ciudad de Tuxtla Gutiérrez, Chiapas.</dd>
                    </dl>
                    <br><dl><dt>II.Declara <b>"EL PRESTADOR DE SERVICIOS"</b> que:</dt>
                        <br><dd>II.1 Es una persona física, de nacionalidad Mexicana, lo cual acredita mediante @if($data->instructor_tipo_identificacion == 'INE')Credencial Para Votar @else{{$data->instructor_tipo_identificacion}}@endif con número de folio <a data-target="#instructorModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#instructorModal">{{$data->instructor_folio_identificacion}}</a>, por lo que cuenta con los conocimientos necesarios de certificación extraordinaria de cursos.</dd>
                ...
                <br><div align="justify">
                    <dd><b>PRIMERA.- OBJETO DEL CONTRATO</b>. En los términos y condiciones del presente contrato <b>“EL PRESTADOR DE SERVICIOS”</b> se obliga a prestar sus servicios profesionales por <b>Honorarios</b> a <b>“EL ICATECH”</b>, consistente en otorgar certificación extraordinaria  que se detalla en el <b>Anexo II</b>, formando parte integrante del presente contrato como si a la letra se insertase, donde se establece bajo que especialidad, periodo de impartición, horario, días, horas que se cubrirán y en el lugar que será impartido la certificación.</dd>
                    ...
                    <Ol type = "I">
                        <li> Diseñar, preparar y certificar los cursos a su cargo con toda la diligencia y esmero que exige la calidad de <b>“EL ICATECH”</b>.</li>
                        <br><li> Asistir con toda puntualidad a certificar y aprovechar íntegramente el tiempo necesario para el mejor desarrollo de los mismos.</li>
                ...
                <div align="justify">
                    ...
                    <br><dd><b>QUINTA.- VIGENCIA</b>. La vigencia del presente contrato será conforme a la duración de la Certificación Extraordinaria del curso objeto del presente Instrumento, detallados en la <b>CLÁUSULA PRIMERA</b>; el cual será forzoso para <b>“EL PRESTADOR DE SERVICIOS”</b> y voluntario para <b>“EL ICATECH”</b> mismo que podrá darlo por terminado anticipadamente en cualquier tiempo, siempre y cuando existan motivos o razones de interés general, incumpla cualquiera de las obligaciones adquiridas con la formalización del presente instrumento o incurra en alguna de las causales previstas en la Cláusula Octava, mediante notificación por escrito a <b>“EL PRESTADOR DE SERVICIOS”</b>; en todo caso <b>“EL ICATECH”</b> deberá cubrir los honorarios únicamente en cuanto a las horas de servicio prestados.</dd>
                ...
                <ol type = "I">
                    ...
                    <li>Por no otorgar la certificación extraordinaria en el tiempo establecido (horas de certificación). </li>
                </ol>
                <div align="justify"><dd>Asimismo, en caso de tener evidencias de que la certificación no fue impartida, se procederá a dar por rescindido el contrato, y se actuará conforme a lo dispuesto por la Ley de Responsabilidad Administrativa para el Estado de Chiapas.</dd>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div>
                        ...
                        <li>Folio de Identificación: <b>{{$data->folio_ine}}</b></li><br>
