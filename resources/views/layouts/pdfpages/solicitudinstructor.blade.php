...
<html>
    ...
    <body style="margin-top:90px; margin-bottom:70px;">
        ...
        <div class= "container">
            ...
            <br><p class="text-justify">Por este medio solicitar el apoyo y colaboración a efecto de llevar a cabo el proceso de @if($tipo_doc == 'REVALIDACION') actualización @elseif($tipo_doc == 'REACTIVACION') reactivación @else validación @endif del instructor que cumple con todos y cada uno de los requisitos que señala el Procedimiento de Reclutamiento, Selección y Validación de instructores de esta institución</p>
            ...
            <p class="text-left">Adjunto a presente, documentación personal del instructor en mención.</p>
            ...
            <br><br><h6><small><b>C.c.p. {{$data_unidad->jcyc}}.- {{$data_unidad->pjcyc}}.-Mismo Fin</b></small></h6>
