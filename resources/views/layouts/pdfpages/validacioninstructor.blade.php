...
@section('content')
    <div style="margin-top: -120px;">
            ...
            <table class="tablag" style="">
                <tbody>
                    <tr>
                        ...
                        <td style='width: 360px;' colspan="2">{{$instructor->apellidoPaterno}}
                            {{$instructor->apellidoMaterno}} {{$instructor->nombre}}</td>
                    </tr>
                    <tr>
                    ...
                    {{-- <tr>
                        ...
                        <td style='width: 360px;' colspan="2"> @if($especialidades[0]->status != 'BAJA EN
                            FIRMA'){{$especialidades[0]->perfil_profesional}} @else
                            {{$especialidades[1]->perfil_profesional}}@endif</td>
                    </tr> --}}
                    <tr>
                        <td style='width: 180px;'><b>OBSERVACIONES:</b></td>
                        <td style='width: 360px;' colspan="2">
                            @if($especialidades[0]->status != 'BAJA EN FIRMA'){{$especialidades[0]->observacion_validacion}}
                            @else {{$especialidades[1]->observacion_validacion}}@endif</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <p style="line-height: 1; font-size: 12px;">Es preciso señalar que, en su expediente consta que cumple con los
            requisitos y documentos que requiere el perfil de la especialidad solicitada.
        ...
        <div>
            <div class="column">
                <table
                    style="border-collapse:initial;font-size: 12px;border: black 1px solid; text-align: center; padding:0.5px;">
                    <thead>
                        <tr>
                            <td>
                                <b>ELABORÓ</b><br><br>
                    ...
                    <thead>
                        <tr>
                            <td>
                                <b>REVISÓ</b><br><br>
                                <b><br>_________________________</b>
                                <br><small><small><small>{{ $funcionarios['gestionacademica']['titulo'] }}
                                            {{ $funcionarios['gestionacademica']['nombre'] }}</small></small></small>
                    ...
                    <thead>
                        <tr>
                            <td>
                                <b>AUTORIZÓ</b><br><br>
                                <b><br>_________________________</b>
                                <br><small><small><small>{{ $funcionarios['dacademico']['titulo'] }}
                                            {{ $funcionarios['dacademico']['nombre'] }}</small></small></small>
        ...
        <div style="font-size: 10px;">
            “Este documento es de uso interno y no tiene validez jurídica ni contractual, se extiende únicamente con fines
            académicos. Estos datos y resultados son considerados confidenciales por lo que se prohíbe su reproducción
            parcial o total para fines distintos al uso interno de la Dirección Técnica Académica y las Unidades de
            Capacitación”.
            <br>
            <small><small>C.c.p. {{ $funcionarios['gestionacademica']['titulo'] }}
                    {{ $funcionarios['gestionacademica']['nombre'] }} .- {{ $funcionarios['gestionacademica']['puesto'] }}.
                    – Para su conocimiento - Edificio.</small></small>
