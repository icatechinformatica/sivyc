            ...
            <div id="content">
                ...
                <div align="justify">
                    ...
                    <br><dl><dt>II.Declara <b>"EL PRESTADOR DE SERVICIOS"</b> que:</dt>
                        <br><dd>II.1 Es una persona física, de nacionalidad Mexicana, lo cual acredita mediante @if($data->tipo_identificacion == 'INE')Credencial Para Votar @else{{$data->tipo_identificacion}}@endif con número de folio <a data-target="#instructorModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#instructorModal">{{$data->folio_ine}}</a>, por lo que cuenta con los conocimientos necesarios de certificación extraordinaria de cursos.</dd>
