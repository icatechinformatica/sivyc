 ...
 @section('content')
        <div>
            @if($data->archivo_fotografia != FALSE)
                ...
                <img style="border: 2px solid black; margin-top: 0px; margin-right: 30px;" class="pull-right"  src="{{ asset('storage'.$data->archivo_fotografia) }}" alt="foto" width="75" height="75">
            @endif
            <br><br><br><br>
