    ...
    <body>
        ...
        <div class= "container g-pt-30" style="font-size: 12px;">
            <div id="content">
                ...
                <br><div align="justify"><b>CONTRATO DE PRESTACIÓN DE SERVICIOS PROFESIONALES POR HONORARIOS EN SU MODALIDAD DE HORAS CURSO, QUE CELEBRAN POR UNA PARTE, EL INSTITUTO DE CAPACITACIÓN Y VINCULACIÓN TECNOLÓGICA DEL ESTADO DE CHIAPAS, REPRESENTADO POR <a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">{{$director->nombre}} {{$director->apellidoPaterno}} {{$director->apellidoMaterno}}</a>, EN SU CARÁCTER DE <a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">{{$director->puesto}} DE CAPACITACIÓN {{$data_contrato->unidad_capacitacion}}</a> Y POR LA OTRA LA O EL C.<a data-target="#instructorModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#instructorModal"> {{$nomins}}</a>, EN SU CARÁCTER DE INSTRUCTOR EXTERNO; A QUIENES EN LO SUCESIVO SE LES DENOMINARÁ “ICATECH” Y “PRESTADOR DE SERVICIOS” RESPECTIVAMENTE; MISMO QUE SE FORMALIZA AL TENOR DE LAS DECLARACIONES Y CLÁUSULAS SIGUIENTES:</b></div>
                <br><div align="center"> DECLARACIONES</div>
                <div align="justify">
                    <dl>
                        <dt>I.Declara <b>“ICATECH”</b> que:<br>
                        ...
                        <br><dd>I.2 La Mtra. Fabiola Lizbeth Astudillo Reyes, en su cáracter de Titular de Dirección General del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, cuenta con personalidad juridica que acredita con nombramiento expedido a su favor por el Dr. Rutilio Escandón Cadenas, Gobernador del Estado de Chiapas, de fecha 16 de enero de 2019, por lo que se encuentra plenamente facultada en términos de lo dispuesto en los artículos 28 fracción I de la Ley de Entidades Paraestatales del Estado de Chiapas; 15 fracción I del Decreto por el que se crea el Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, así como el 13 fracción IV del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, mismas que no le han sido limitadas o revocadas por lo que, delega su representación a los Titulares de las Unidades de Capacitación conforme a lo dispuesto por el artículo 29 fracción I del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas.</dd>
                        <br><dd>I.3 <a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">{{$director->nombre}} {{$director->apellidoPaterno}} {{$director->apellidoMaterno}}</a>, <a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">{{$director->puesto}} de la Unidad de Capacitación {{$data_contrato->unidad_capacitacion}}</a> tiene personalidad jurídica para representar en este acto a “ICATECH”, como lo acredita con el nombramiento expedido por la Titular de la Dirección General del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, y cuenta con plena facultad legal para suscribir el presente Instrumento conforme a lo dispuesto por los artículos 29 fracción I del Reglamento Interior del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas y 12 fracción V, de los Lineamientos para los Procesos de Vinculación y Capacitación del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas.</dd>
                        ...
                        <br><dd>I.5 De acuerdo a las necesidades de <b>“ICATECH”</b>, se requiere contar con los servicios de una persona física con conocimientos en <a data-target="#instructorModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#instructorModal">{{$especialidad->nombre}}</a>, por lo que se ha determinado llevar a cabo la Contratación por <b>HONORARIOS</b> en la modalidad de horas curso como <b>"PRESTADOR DE SERVICIOS"</b>.</dd>
                        <br><dd>I.6 Para los efectos del presente contrato se cuenta con la la clave de grupo {{$data->clave}} y validación del instructor emitido por la Dirección Técnica Académica de <b>“ICATECH”</b> conforme a lo dispuesto por el artículo 4 fracción III de los Lineamientos para los Procesos de Vinculación y Capacitación del Instituto de Capacitación y Vinculación Tecnológica del Estado de Chiapas, emitido por la Dirección Técnica Académica de <b>“ICATECH”</b>.</dd>
                    ...
                    <br><dl><dt>II.Declara <b>"PRESTADOR DE SERVICIOS"</b> que:</dt>
                        ...
                        <br><dd>II.5 Para los efectos del presente contrato, señala como su domicilio legal el ubicado en <a data-target="#instructorModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#instructorModal">{{$data->domicilio}}</a>.</dd>
                    </dl>
                </div>
                ...
                <br><div align="justify">
                    <dd><b>PRIMERA.- OBJETO DEL CONTRATO</b>. El presente instrumento tiene por objeto establecer al <b>“PRESTADOR DE SERVICIOS”</b> los términos y condiciones que se obliga con <b>“ICATECH”</b>, a brindar sus servicios profesionales bajo el régimen de HONORARIOS, para otorgar el curso establecido en el ARC01 y/o ARC02.</dd>
                    <br><dd><b>SEGUNDA.- MONTO DE LOS HONORARIOS</b>. El monto total de los servicios que <b>“ICATECH”</b>, pagará al <b>“PRESTADOR DE SERVICIOS”</b> será por la cantidad de <b><a data-target="#contratoModal" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#contratoModal">${{$cantidad}} ({{$data_contrato->cantidad_letras1}} {{$monto['1']}}/100 M.N.)</a></b>, más el 16% (dieciséis por ciento) del Impuesto al Valor Agregado, menos las retenciones que de conformidad con la Ley del Impuesto Sobre la Renta, y demás disposiciones fiscales que procedan para el caso que nos ocupa.</dd>
                    <br><dd>El monto resultante señalado en el párrafo primero de esta cláusula se otorgará al <b>“PRESTADOR DE SERVICIOS”</b> conforme a la disponibilidad financiera de <b>“ICATECH”</b>; que se realizará en una sola exhibición, por medio de transferencia electrónica interbancaria a la cuenta que señala, contra la entrega del Recibo de Honorarios y/o Factura correspondiente, mismo que deberá cubrir los requisitos fiscales estipulados por la Secretaría de Hacienda y Crédito Público; por lo que el <b>“PRESTADOR DE SERVICIOS”</b> no podrá exigir retribución alguna por ningún otro concepto</dd>
                ...
                <div align="justify">
                    ...
                    <br><dd>Concluido el término del presente contrato no podrá haber prórroga automática por el simple transcurso del tiempo y terminará sin necesidad de darse aviso entre las partes. Si terminada la vigencia de este contrato, <b>“ICATECH”</b> tuviere necesidad de seguir utilizando los servicios de <b>“PRESTADOR DE SERVICIOS”</b>, se requerirá la celebración de un nuevo contrato, sin que éste pueda ser computado con el anterior.</dd>
                ...
                <div align="justify"><dd>Asimismo; en caso de tener evidencias de que el curso no fue impartido, se procederá a dar por rescindido el contrato, y se interpondrá la acción legal que corresponda.</dd>
                    ...
                    <br><dd><b>DÉCIMA TERCERA.- DOMICILIOS</b>. Para los efectos del presente instrumento las partes señalan como sus domicilios legales los estipulados en el Apartado de Declaraiciones del presente instrumento legal.</dd>
