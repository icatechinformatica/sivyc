                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="permiso-name" class="form-control" >
                            </div>
                          </div>
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="permiso-slug" class="form-control" >
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea rows="4" class="form-control" name="permiso-descripcion"></textarea>
                            </div>
                          </div>
