...
@section('title', 'Alta/Baja de Convenio | Sivyc Icatech')
<head>
    <style>
...
@section('content')
    <section class="container g-py-40 g-pt-40 g-pb-0">
        <form method="POST" action="{{ route('convenio-alta-baja-save') }}" id="alta-bajaconvenio">
            @csrf
            <div class="text-center">
                <h1>Alta/Baja de Convenio<h1>
            </div>
            <br>
            <table  id="table-instructor" class="table table-bordered table-responsive-md">
                <caption>Catalogo de Convenio</caption>
                <thead>
                    <tr>
