    ...
    @section('script_content_js') 
        ...
        <script language="javascript"> 
            $(document).ready(function(){
                ...
                var curso = JSON.parse('{"label":["CATAZAJA","COMITAN","JIQUIPILAS","OCOSINGO","REFORMA","SAN CRISTOBAL","TAPACHULA","TONALA","TUXTLA","VILLAFLORES","YAJALON"],"total":[6,6,1,7,0,3,3,2,13,2,7]}'); 
                var myChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels: curso.label,
