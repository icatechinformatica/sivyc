...
@section('content')
@php
    $canCreateContrato = auth()->user()->can('contratos.create');
    $canEditContrato = auth()->user()->can('contratos.edit');
    $canCancelFolio = auth()->user()->can('folio.cancel');
    $canUploadSupre = auth()->user()->can('supre.upload_supre');
    $canRestartContrato = auth()->user()->can('contrato.restart');
@endphp
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($itemData->status == 'Validado')
                                ...
                                @endif
                                @if($itemData->permiso_editar && $canUploadSupre)
