...
@section('content')
    <div class="container g-pt-50">
        ...
        <form method="POST" id="sid_registro_modificacion_jefe_unidad" action="{{ route('sid.modificar-jefe-unidad', ['idAspirante' => base64_encode($alumno->id) ]) }}">
            @csrf
            @method('PUT')
            <div class="form-row">
                <!-- apellido paterno -->
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="curp_mod" class="control-label">CURP:</label>
                    <input type="text" name="curp_mod" id="curp_mod" class="form-control" value="{{$alumno->curp}}">
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    @can('alumnos.inscripcion-jefe-unidad-update')
