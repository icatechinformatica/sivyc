       ...
       <div style="text-align: right;width:82%">
        ...
        <div class="field_wrapper">
            <table class="table table-bordered" id="dynamicTable">
                ...
                <tr>
                    <td><input type="text" name="addmore[0][folio]" id="addmore[0][folio]" placeholder="folio" class="form-control" value="{{$folio_validacion}}" readonly /><footer name="addmore[0][avisofolio]" id="addmore[0][avisofolio]" style="color: red"></footer></td>
