...
<style>
 ...
 <div class="container g-pt-50">
   <form action="{{ route('folio-especialedit-save') }}" id="regsupre" method="POST">
       @csrf
       <div style="text-align: right;width:82%">
           <label for="tituloSupre1"><h2>Modificación de Folio Validado</h2></label>
        </div>
        <br>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" id="no_memo" name="no_memo" aria-required="true" value="{{ $supre->no_memo }}" placeholder="ICATECH/0000/000/2020">
            </div>
            <div class="form-group col-md-2">
                <label for="fecha" class="control-label">Fecha</label>
                <input class="form-control" name="fecha" type="date" aria-required="true" value="{{ $supre->fecha }}" id="fecha">
            </div>
        </div>
        <!--<div class="form-row">
        ...
        <div class="field_wrapper">
            <table class="table table-bordered" id="dynamicTablemodsupre">
                ...
                <tr>
                    <td><input type="text" id="addmore[0][folio]" name="addmore[0][folio]" value="{{ $folio->folio_validacion }}" placeholder="folio" class="form-control" /></td>
                    <td><input type="text" id="addmore[0][numeropresupuesto]" readonly name="addmore[0][numeropresupuesto]" value="12101" placeholder="numero presupuesto" class="form-control" /></td>
                    <td><input type="text" id="addmore[0][clavecurso]" name="addmore[0][clavecurso]" value="{{ $clave->clave}}" placeholder="clave curso" class="form-control" /></td>
                    <td><input type="text" id="addmore[0][importe]" name="addmore[0][importe]" value="{{ $folio->importe_total }}" placeholder="importe total" class="form-control" readonly /><footer name="addmore[0][aviso]" id="addmore[0][aviso]" style="color: red"></footer></td>
                    <td><input type="text" id="addmore[0][iva]" name="addmore[0][iva]" value="{{ $folio->iva }}" placeholder="Iva" class="form-control" readonly /></td>
                    <td><input type="text" id="addmore[0][comentario]" name="addmore[0][comentario]" value="{{ $folio->comentario }}" placeholder="comentario" class="form-control" /></td>
                    <input hidden id="addmore[0][id_cursos]" name="addmore[0][id_cursos]" value="{{$folio->id_cursos}}">
                </tr>
            </table>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6"> <!--  -->
                ...
                <input type="text" class="form-control" aria-required="true" value="{{$getremitente->nombre}} {{$getremitente->apellidoPaterno}} {{$getremitente->apellidoMaterno}}" onkeypress="return soloLetras(event)" id="remitente" name="remitente" placeholder="Nombre">
            </div>
            <div class="form-group col-md-6"> <!--  -->
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" aria-required="true" value="{{$getvalida->nombre}} {{$getvalida->apellidoPaterno}} {{$getvalida->apellidoMaterno}}" onkeypress="return soloLetras(event)" id="nombre_valida" name="nombre_valida" placeholder="Nombre">
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" aria-required="true" value="{{$getelabora->nombre}} {{$getelabora->apellidoPaterno}} {{$getelabora->apellidoMaterno}}" onkeypress="return soloLetras(event)" id="nombre_elabora" name="nombre_elabora" placeholder="Nombre">
            </div>
            <div class="form-group col-md-4">
        ...
        <- START CCP ->
            ...
            <div class="form-row">
                <div class="form-group col-md-4"> <-- copia 1 ->
                    ...
                    <input type="text" class="form-control" aria-required="true" value="{getccp1->nombre}} {getccp1->apellidoPaterno}} {getccp1->apellidoMaterno}}" onkeypress="return soloLetras(event)" id="nombre_ccp1" name="nombre_ccp1" placeholder="Nombre">
                </div>
                <div class="form-group col-md-4"> <--  ->
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="remitente" class="control-label">Nombre</label>
                    <input type="text" class="form-control" aria-required="true" value="{getccp2->nombre}} {getccp2->apellidoPaterno}} {getccp2->apellidoMaterno}}" onkeypress="return soloLetras(event)" id="nombre_ccp2" name="nombre_ccp2" placeholder="Nombre">
                </div>
                <div class="form-group col-md-4"> <--  ->
                    <label for="remitente" class="control-label">Puesto</label>
        ...
        <br>
        <div class="row">
            <input hidden id=id_supre name="id_supre" value="{{$supre->id}}">
            <input hidden id=id_folio name="id_folio" value="{{$folio->id_folios}}">
