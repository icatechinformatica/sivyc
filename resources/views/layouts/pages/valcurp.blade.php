    ...
    <div class="card card-body" >
            ...
            <div class="row justify-content-center">
                <div class="for row">
                    <div class="form-group col-md-6">
                        ...
                        <br><pre id="resultado" name='resultado'></pre>
                    </div>
        ...
        <form method="POST" id="form_sid" action="{{ route('alumnos.save') }}" enctype="multipart/form-data">
            ...
            <div class="col-lg-12 margin-tb">
                ...
                <hr style="border-color:dimgray">
                <div align="center"><h4><b>DATOS PERSONALES</b></h4></div> <br><br>
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="email" id="correo" name="correo" class="form-control" placeholder="usuario@gmail.com" type="text" />                            
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                        <br />
                        <label><input id="recibir_publicaciones" name="recibir_publicaciones" type="checkbox" value="true">&nbsp;&nbsp;¿Recibir publicaciones?</label>                                                        
                    </div>                       
                </div>
                <div class="form-row">
                    <!-- domicilio -->
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">                        
                        <label><input id="madre_soltera" name="madre_soltera" type="checkbox" value="true"/>&nbsp;&nbsp;¿Es Madre Soltera?</label>
                    </div>
                    <div class="form-group col-md-3">
                        <label><input id="familia_migrante" name="familia_migrante" type="checkbox" value="true"/>&nbsp;&nbsp;¿Tiene Familia Migrante?</label>
                    </div>
                    <div class="form-group col-md-2">
                        <label><input id="inmigrante" name="inmigrante" type="checkbox" value="true">&nbsp;&nbsp;¿Es Inmigrante?</label>
                    </div>
                    <div class="form-group col-md-2">
                        <label>
                            <input id="indigena" name="indigena" type="checkbox" value="true"/>&nbsp;&nbsp¿Es Indígena?
                        </label>
                    </div>
                    <div class="form-group col-md-2">     
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label><input type="checkbox" id="trabajo" name="trabajo" value="true" onchange="javascript:showContent()">&nbsp;&nbsp;¿El aspirante está empleado?</label>
                    </div>
                </div>
                        ...
                        <div class="form-row"> 
                            <div class="form-group col-md-6">
                                <table class="table table-striped" style="width: 100%; text-align: left; border-collapse: collapse;">
                                    <tr>
                                        <td style="width: 20%;"><label><input id="chk_acta" name="chk_acta" type="checkbox" value="true"/>&nbsp;&nbsp;Acta de Nacimiento</label> </td>
                                        <td>
                                            <div>
                                                <label for="">FECHA DE EXPEDICIÓN ACTA DE NACIMIENTO&nbsp;&nbsp;</label>
                                                <input type="date" name="fecha_expedicion_acta_nacimiento" id="fecha_expedicion_acta_nacimiento">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><label><input id="chk_curp" name="chk_curp" type="checkbox" value="true"/>&nbsp;&nbsp;CURP</label></td>
                                        <td>
                                            <div>
                                    ...
                                    <tr>
                                        <td><label><input id="chk_escolaridad" name="chk_escolaridad" type="checkbox" value="true"/>&nbsp;&nbsp;&Uacute;ltimo Grado de Estudios</label></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td><label><input id="chk_comprobante_migratorio" name="chk_comprobante_migratorio" type="checkbox" value="true"/>&nbsp;&nbsp;Comprobante Migratorio</label></td>
                                        <td>
                                            <div>
                                                <label for="">FECHA DE VIGENCIA DE COMPROBANTE MIGRATORIO</label>
                                                <input type="date" name="fecha_vigencia_migratorio" id="fecha_vigencia_migratorio">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label><input type="checkbox" id="cerss_chk" name="cerss_chk" value="true" onchange="javascript:showContent()">&nbsp;&nbsp;¿El aspirante pertenece a algún cereso?</label>
                        </div>
                    </div>
        ...
        <form method="POST" id="sid_registro_modificacion" action="{{ route('sid.modificar', ['idAspirante' => base64_encode($alumno->id) ])}}" enctype="multipart/form-data">
            @csrf
                <div class="col-lg-12 margin-tb">
                    ...
                    <hr style="border-color:dimgray">
                    <div align="center"><h4><b>DATOS PERSONALES</b></h4></div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <table class="table table-striped">
                                <tr>
                                    <td>
                                        <span><i class="fa fa-camera-retro fa-3x" style="vertical-align: middle"></i></span>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="fotografia_mod" name="fotografia_mod" onchange="fileValidationmod()">
                                            <label class="custom-file-label" for="fotografia_mod">SELECCIONAR FOTOGRAFIA</label>
                                        </div>
                                    </td>
                                    @if(isset($alumno->fotografia))
                                    <td>
                                        <a name="fotografia_url_mod" id="doc_url_mod" href="{{$alumno->fotografia}}" target="blank" class="btn btn-primary">IMAGEN PRECARGADA</a>
                                    </td>
                                    @endif
                                </tr>
                            </table>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="nombre_mod" name="nombre_mod" autocomplete="off" value="{{$alumno->nombre}}">
                        </div>
                        <!--nombre aspirante END-->
                        <!-- apellido paterno -->
                        <div class="form-group col-md-4">
                            <label for="apellidoPaterno_mod" class="control-label">Apellido Paterno</label>
                            <input type="text" class="form-control" id="apellidoPaterno_mod" name="apellidoPaterno_mod" autocomplete="off" value="{{$alumno->apellido_paterno}}">
                        </div>
                        <!-- apellido paterno END -->
                        <!-- apellido materno-->
                        <div class="form-group col-md-4">
                            <label for="apellidoMaterno_mod" class="control-label">Apellido Materno</label>
                            <input type="text" class="form-control" id="apellidoMaterno_mod" name="apellidoMaterno_mod" autocomplete="off" value="{{$alumno->apellido_materno}}" >
                        </div>
                        <!-- apellido materno END-->
                        <div class="form-group col-md-2">
                            <label for="">Fecha de nacimiento</label>
                        ...
                        <div class="form-group col-md-2">
                            <label>Nacionalidad:</label>
                            <input id="nacionalidad_mod" name="nacionalidad_mod" class="form-control" type="text" value="{{$alumno->nacionalidad}}" />                            
                        </div>
                        <div class="form-group col-md-3">
                            <label>Tel&eacute;fono Casa:</label>
                            <input id="telefono_casa_mod" name="telefono_casa_mod" class="form-control" type="text" value="{{$alumno->telefono_casa}}" />                            
                        </div>
                        <div class="form-group col-md-3">
                            <label>Tel&eacute;fono Celular:</label>
                            <input id="telefono_cel_mod" name="telefono_cel_mod" class="form-control" type="text" value="{{$alumno->telefono_personal}}" />                            
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            <label>Correo Electr&oacute;nico:</label>
                            <input type="email" id="correo_mod" name="correo_mod" class="form-control" placeholder="usuario@gmail.com" type="text" value="{{$alumno->correo}}" />                            
                        </div>
                        <div class="form-group col-md-3">
                            <label>Facebook:</label>
                            <input id="facebook_mod" name="facebook_mod" class="form-control" type="text" value="{{$alumno->facebook}}" />                            
                        </div> 
                        <div class="form-group col-md-3">
                            <label>Twitter:</label>
                            <input id="twitter_mod" name="twitter_mod" class="form-control" type="text" value="{{$alumno->twitter}}" />                            
                        </div>
                        <div class="form-group col-md-3">
                            <br />
                            @if($alumno->recibir_publicaciones=='true')
                            <label><input id="recibir_publicaciones_mod" name="recibir_publicaciones_mod" type="checkbox" value="true" checked>&nbsp;&nbsp;¿Recibir publicaciones?</label>
                            @else
                            <label><input id="recibir_publicaciones_mod" name="recibir_publicaciones_mod" type="checkbox" value="true">&nbsp;&nbsp;¿Recibir publicaciones?</label>
                            @endif                                                        
                        </div>                       
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="domicilio_mod" name="domicilio_mod" autocomplete="off" value="{{$alumno->domicilio}}">
                        </div>
                        <!-- domicilio END -->
                        <div class="form-group col-md-4">
                            <label for="colonia_mod" class="control-label">Colonia o Localidad</label>
                            <input type="text" class="form-control" id="colonia_mod" name="colonia_mod" autocomplete="off" value="{{$alumno->colonia}}">
                        </div>
                        <!--COLONIA END-->
                        <div class="form-group col-md-4">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" id="estados_mod" name="estados_mod" >
                                @isset($alumno->estado)<option value="{{$alumno->estado}}">{{$alumno->estado}}@else<option value="">--SELECCIONAR--</option>@endisset
                                @foreach ($estados as $id=>$nombre)
                                    <option value="{{ $nombre }}">{{ $nombre }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" id="municipios_mod" name="municipios_mod" >
                                @isset($alumno->municipio)<option value="{{$alumno->municipio}}">{{$alumno->municipio}}@else<option value="">--SELECCIONAR--</option>@endisset
                            </select>
                        </div>
                        <div class="form-group col-md-3"> 
                            <label>Estado civil:</label> 
                            <select class="form-control mr-sm--2" id="estado_civil_mod" name="estado_civil_mod" >
                                @isset($alumno->estado_civil)<option value="{{$alumno->estado_civil}}">{{$alumno->estado_civil}}@else<option value="">--SELECCIONAR--</option>@endisset
                                @foreach ($estado_civil as $item)
                                    <option value="{{ $item }}">{{ $item }}</option>
                                @endforeach
                            </select>                    
                        ...
                        <div class="form-group col-md-3"> 
                            ...
                            <select name="discapacidad_mod" id="discapacidad_mod" class="form-control mr-sm--2" >
                                @isset($alumno->discapacidad)<option value="{{$alumno->discapacidad}}">{{$alumno->discapacidad}}@else<option value="">--SELECCIONAR--</option>@endisset
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">  
                            ...
                            <label><input id="madre_soltera_mod" name="madre_soltera_mod" type="checkbox" value="true" checked/>&nbsp;&nbsp;¿Es Madre Soltera?</label>
                            @else
                            <label><input id="madre_soltera_mod" name="madre_soltera_mod" type="checkbox" value="true"/>&nbsp;&nbsp;¿Es Madre Soltera?</label>
                            @endif
                        </div>
                        <div class="form-group col-md-3">
                            @if($alumno->familia_migrante=='true')
                            <label><input id="familia_migrante_mod" name="familia_migrante_mod" type="checkbox" value="true" checked/>&nbsp;&nbsp;¿Tiene Familia Migrante?</label>
                            @else
                            <label><input id="familia_migrante_mod" name="familia_migrante_mod" type="checkbox" value="true" />&nbsp;&nbsp;¿Tiene Familia Migrante?</label>
                            @endif
                        </div>
                        <div class="form-group col-md-2">
                            @if($alumno->inmigrante=='true')
                            <label><input id="inmigrante_mod" name="inmigrante_mod" type="checkbox" value="true" checked>&nbsp;&nbsp;¿Es Inmigrante?</label>
                            @else
                            <label><input id="inmigrante_mod" name="inmigrante_mod" type="checkbox" value="true">&nbsp;&nbsp;¿Es Inmigrante?</label>
                            @endif
                        </div>
                        <div class="form-group col-md-2">
                            @if($alumno->indigena=='true')
                            <label><input id="indigena_mod" name="indigena_mod" type="checkbox" value="true" / checked>&nbsp;&nbsp;¿Es Indígena?</label>
                            @else
                            <label><input id="indigena_mod" name="indigena_mod" type="checkbox" value="true" />&nbsp;&nbsp;¿Es Indígena?</label>
                            @endif
                        </div>
                        <div class="form-group col-md-2">  
                            <select name="etnia_mod" id="etnia_mod" class="form-control mr-sm--2" placeholder="--ETNIA--">
                                @isset($alumno->etnia)@if($alumno->etnia=='')<option value="">--ETNIA--</option>@else<option value="{{$alumno->etnia}}">{{$alumno->etnia}}</option>@endif @else<option value="">--ETNIA--</option> @endisset
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="ultimo_grado_estudios_mod" name="ultimo_grado_estudios_mod">
                                @isset($alumno->ultimo_grado_estudios)<option value="{{$alumno->ultimo_grado_estudios}}">{{$alumno->ultimo_grado_estudios}}</option>@else<option value="">--SELECCIONAR--</option>@endisset
                                @foreach ($grado_estudio as $itemGradoEstudio => $val)
                                    <option value="{{$val}}">{{$val}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="motivos_eleccion_sistema_capacitacion_mod" id="motivos_eleccion_sistema_capacitacion_mod">
                                @isset($alumno->sistema_capacitacion_especificar)@if ($alumno->sistema_capacitacion_especificar!='PARA EMPLEARSE O AUTOEMPLEARSE'&& $alumno->sistema_capacitacion_especificar!='PARA AHORRAR GASTOS AL INGRESO FAMILIAR'&&$alumno->sistema_capacitacion_especificar !='POR ESTAR EN ESPERA DE INCORPORARSE A OTRA INSTITUCIÓN EDUCATIVA'&&$alumno->sistema_capacitacion_especificar !='PARA MEJORAR SU SITUACIÓN EN EL TRABAJO'&&$alumno->sistema_capacitacion_especificar !='POR DISPOSICIÓN DE TIEMPO LIBRE'&&$alumno->sistema_capacitacion_especificar!='')<option value="0">OTRO</option> @else<option value="{{$alumno->sistema_capacitacion_especificar}}">{{$alumno->sistema_capacitacion_especificar}} @endif @else<option value="">--SELECCIONAR--</option>@endisset
                                <option value="PARA EMPLEARSE O AUTOEMPLEARSE">PARA EMPLEARSE O AUTOEMPLEARSE</option>
                                <option value="PARA AHORRAR GASTOS AL INGRESO FAMILIAR">PARA AHORRAR GASTOS AL INGRESO FAMILIAR</option>
                                <option value="POR ESTAR EN ESPERA DE INCORPORARSE A OTRA INSTITUCIÓN EDUCATIVA">POR ESTAR EN ESPERA DE INCORPORARSE A OTRA INSTITUCIÓN EDUCATIVA</option>
                                <option value="PARA MEJORAR SU SITUACIÓN EN EL TRABAJO">PARA MEJORAR SU SITUACIÓN EN EL TRABAJO</option>
                        ...
                        <div class="form-group col-md-6">
                            <div class="motivo_capacitacion_especificar">
                                <label for="motivo_sistema_capacitacion_especificar_mod" class="control-label">ESPECIFIQUE:</label>
                    ...
                    <div >
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <label><input type="checkbox" id="trabajo_mod" name="trabajo_mod" value="true"  checked>&nbsp;&nbsp;¿El aspirante está empleado?</label>
                            </div> 
                            @else
                            <div class="form-group col-md-4">
                                <label><input type="checkbox" id="trabajo_mod" name="trabajo_mod" value="true" >&nbsp;&nbsp;¿El aspirante está empleado?</label>
                            </div>
                            @endif
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="empresa_mod" id="empresa_mod" class="form-control" autocomplete="off" value="{{$alumno->empresa_trabaja}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="puesto_empresa_mod" class="control-label">PUESTO:</label>
                                <input type="text" name="puesto_empresa_mod" id="puesto_empresa_mod" class="form-control" autocomplete="off" value="{{$alumno->puesto_empresa}}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="antiguedad_mod" class="control-label">ANTIGUEDAD:</label>
                                <input type="text" name="antiguedad_mod" id="antiguedad_mod" class="form-control" autocomplete="off" value="{{$alumno->antiguedad}}">
                            </div>
                            <div class="form-group col-md-8">
                                <label for="direccion_empresa_mod" class="control-label">DIRECCIÓN:</label>
                                <input type="text" name="direccion_empresa_mod" id="direccion_empresa_mod" class="form-control" autocomplete="off" value="{{$alumno->direccion_empresa}}">
                            </div>
                        </div>
                    </div>
                    <hr style="border-color: dimgray">
                    <h5><b>REQUISITOS</b></h5>
                                    ...
                                    <table class="table table-striped">
                                            ...
                                            <td>
                                                <div class="form-inline">
                                                    @if (@isset($requisitos)||$alumno->chk_acta_nacimiento=='true') 
                                                        ...
                                                        <label><input id="chk_acta_mod" name="chk_acta_mod" type="checkbox" value="true" checked/>&nbsp;&nbsp;Acta de Nacimiento</label>
                                                        @else
                                                        <label><input id="chk_acta_mod" name="chk_acta_mod" type="checkbox" value="true"/>&nbsp;&nbsp;Acta de Nacimiento</label>
                                                        @endif
                                                    @else
                                                    <label><input id="chk_acta_mod" name="chk_acta_mod" type="checkbox" value="true"/>&nbsp;&nbsp;Acta de Nacimiento</label>
                                                    @endif                     
                                            ...
                                            <td>
                                                ...
                                                <div class="form-inline">
                                                    <div>
                                                        ...
                                                        <input type="date" name="fecha_expedicion_acta_nacimiento_mod" id="fecha_expedicion_acta_nacimiento_mod" value="{{$requisitos->fecha_expedicion_acta_nacimiento}}">
                                                    </div>
                                                @if ($vigencia_acta>=730)
                                                    <div class="form-group col-md-6">
                                                        <a class="btn btn-danger" id="vigencia_mod" name="vigencia_mod" readonly>LA VIGENCIA DEL DOCUMENTO ACTA DE NACIMIENTO HA EXPIRADO, ACTUALIZAR REQUISITO A LA BREVEDAD</a>
                                                    </div>
                                                @endif
                                                </div>
                                                @else
                                                <div>
                                                    <label for="">FECHA DE EXPEDICIÓN ACTA DE NACIMIENTO <br></label>
                                                    <input type="date" name="fecha_expedicion_acta_nacimiento_mod" id="fecha_expedicion_acta_nacimiento_mod">
                                                </div>
                                                @endif
                                            </td>
                                            @if (empty($requisitos))
                                                <td>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <a name="doc_url_acta_naci_mod" id="doc_url_acta_naci_mod" href="{{$alumno->acta_nacimiento}}" target="blank" class="btn btn-danger">PDF</a>
                                                    </div>
                                                    @endif
                                                </td>
                                            @endif
                                            ...
                                            <td>
                                                <div class="form-inline">
                                                    @if(isset($requisitos)||$alumno->chk_curp=='true')
                                                        ...
                                                        <label><input id="chk_curp_mod" name="chk_curp_mod" type="checkbox" value="true" checked/>&nbsp;&nbsp;CURP</label>
                                                        @else
                                                        <label><input id="chk_curp_mod" name="chk_curp_mod" type="checkbox" value="true"/>&nbsp;&nbsp;CURP</label>
                                                        @endif 
                                                    @else
                                                    <label><input id="chk_curp_mod" name="chk_curp_mod" type="checkbox" value="true"/>&nbsp;&nbsp;CURP</label>
                                                    @endif                               
                                            ...
                                            <td>
                                                ...
                                                <DIV class="form-inline">
                                                    <div>
                                                        ...
                                                        <input type="date" name="fecha_expedicion_curp_mod" id="fecha_expedicion_curp_mod" value="{{$requisitos->fecha_expedicion_curp}}">
                                                    </div>
                                                @if ($vigencia_curp>=365)
                                                    <div class="form-group col-md-6">
                                                        <a class="btn btn-danger" id="vigencia_mod" name="vigencia_mod" readonly>LA VIGENCIA DEL DOCUMENTO CURP HA EXPIRADO, ACTUALIZAR REQUISITO A LA BREVEDAD</a>
                                                    </div>
                                                @endif
                                                </DIV>
                                                @else
                                                <div>
                                                    <label for="">FECHA DE EXPEDICIÓN CURP <br></label>
                                                    <input type="date" name="fecha_expedicion_curp_mod" id="fecha_expedicion_curp_mod">
                                                </div>
                                                @endif
                                            </td>
                                            @if (empty($requisitos))
                                                <td>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <a name="doc_url_curp_mod" id="doc_url_curp_mod" href="{{$alumno->documento_curp}}" target="blank" class="btn btn-danger">PDF</a>
                                                    </div>
                                                    @endif
                                                </td>
                                            @endif
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-inline">
                                                    @if(isset($requisitos)||$alumno->chk_comprobante_ultimo_grado=='true')
                                                        ...
                                                        <label><input id="chk_escolaridad_mod" name="chk_escolaridad_mod" type="checkbox" value="true" checked/>&nbsp;&nbsp;&Uacute;ltimo Grado de Estudios</label> 
                                                        @else
                                                        <label><input id="chk_escolaridad_mod" name="chk_escolaridad_mod" type="checkbox" value="true"/>&nbsp;&nbsp;&Uacute;ltimo Grado de Estudios</label>
                                                        @endif
                                                    @else
                                                    <label><input id="chk_escolaridad_mod" name="chk_escolaridad_mod" type="checkbox" value="true"/>&nbsp;&nbsp;&Uacute;ltimo Grado de Estudios</label>
                                                    @endif
                                            ...
                                            @if (empty($requisitos))
                                                <td>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <a name="doc_url_ultimo_grado_mod" id="doc_url_ultimo_grado_mod" href="{{$alumno->comprobante_ultimo_grado}}" target="blank" class="btn btn-danger">PDF</a>
                                                    </div>
                                                    @endif
                                                </td>
                                            @endif
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-inline">
                                                    @if(isset($requisitos)||$alumno->chk_comprobante_calidad_migratoria=='true')
                                                        ...
                                                        <label><input id="chk_comprobante_migracion_mod" name="chk_comprobante_migratorio_mod" type="checkbox" value="true" checked/>&nbsp;&nbsp;Comprobante Migratorio</label>
                                                        @else
                                                        <label><input id="chk_comprobante_migracion_mod" name="chk_comprobante_migratorio_mod" type="checkbox" value="true"/>&nbsp;&nbsp;Comprobante Migratorio</label>  
                                                        @endif
                                                    @else
                                                    <label><input id="chk_comprobante_migracion_mod" name="chk_comprobante_migratorio_mod" type="checkbox" value="true"/>&nbsp;&nbsp;Comprobante Migratorio</label>
                                                    @endif                          
                                            ...
                                            <td>
                                                ...
                                                <div class="form-inline">
                                                    <div>
                                                        <label for="">FECHA DE VIGENCIA DE COMPROBANTE MIGRATORIO <br></label>
                                                        <input type="date" name="fecha_vigencia_migratorio_mod" id="fecha_vigencia_migratorio_mod" value="{{$requisitos->fecha_vigencia_migratorio}}">
                                                    </div>
                                                @if ($vigencia_migracion==true)
                                                    <div class="form-group col-md-6">
                                                        <a class="btn btn-danger" id="vigencia_mod" name="vigencia_mod" readonly>LA VIGENCIA DEL DOCUMENTO COMPROBANTE MIGRATORIO HA EXPIRADO, ACTUALIZAR REQUISITO A LA BREVEDAD</a>
                                                    </div>
                                                @endif
                                                </div>
                                                @else
                                                <div>
                                                    <label for="">FECHA DE VIGENCIA DE COMPROBANTE MIGRATORIO <br></label>
                                                    <input type="date" name="fecha_vigencia_migratorio_mod" id="fecha_vigencia_migratorio_mod">
                                                </div>
                                                @endif
                                            </td>
                                            @if (empty($requisitos))
                                                <td>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <a name="doc_url_compro_migra_mod" id="doc_url_compro_migra_mod" href="{{$alumno->comprobante_calidad_migratoria}}" target="blank" class="btn btn-danger">PDF</a>
                                                    </div>
                                                    @endif
                                                </td>
                                            @endif
                                            ...
                                            <td>
                                                ...
                                                <div class="form-inline col-md-12">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" id="customFile_mod" name="customFile_mod" onchange="fileValidationpdfmod()">
                                                            <label class="custom-file-label" for="customFile_mod">SELECCIONAR DOCUMENTO</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-5">
                                                        <a name="doc_url_mod" id="doc_url_mod" href="{{$requisitos->documento}}" target="blank" class="btn btn-danger">PDF</a>
                                                    </div>
                                                </div>
                                                @else   
                                                <div class="form-group col-md-4">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <label><input type="checkbox" id="cerss_chk_mod" name="cerss_chk_mod" value="true"  checked>&nbsp;&nbsp;¿El aspirante pertenece a algún cereso?</label>
                                    @else
                                    <label><input type="checkbox" id="cerss_chk_mod" name="cerss_chk_mod" value="true" >&nbsp;&nbsp;¿El aspirante pertenece a algún cereso?</label>
                                    @endif
                                </div>
                            </div>
                            <div id="datos_cerss" >
                    ...
                    <div class="row">
                        <div class="col-lg-12 margin-tb">
                            <div class="pull-right">
                                <button type="submit" class="btn btn-warning" id="guardarMod">GUARDAR MODIFICACIÓN</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script_content_js')
    <script type="text/javascript">
        ...
        function validarInputMod(input) {
            if( !$('#cerss_ok').prop('checked') ){                        
                var curp = input.value.toUpperCase(),
                resultado = document.getElementById("resultado2"),valido = "No válido";
        ...
        $(function(){
            $('#estado').on("change",function(){
                ...
                if($(estados_id != '')){
                    $.get('municipio_nov',{estado_id: estados_id}, function(municipio){
                        $('#municipio').empty();
            ...
            $(document).ready(function(){
                ...
                $('#curp_mod').keyup(function(e){
                    var fa=$(this).val();
                    $.get('/alumnos/fecha_s', {fa:fa},function(low){
            ...
            $('#estados_mod').on("change",function(){
                ...
                var estados_id=$(this).val();
                if($(estados_id != '')){
                    $.get('/alumnos/municipio_nov',{estado_id: estados_id}, function(novo){
                        $('#municipios_mod').empty();
                       // $('#titular_cerss').append("<option value=''>Titular cerss</option>");
                        $.each(novo, function(index,value){
                            $('#municipios_mod').append("<option value='" + value + "'>" + value + "</option>");
                        });
                    });
                }
            });
