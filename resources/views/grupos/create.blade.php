        ...
        <div class="col-md-9">
            ...
            <div class="col-12 mb-4 step-section" id="info_general">
                ...
                <div class="p-3 mb-2">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        {{ html()->button('Guardar Info. General')->class('btn btn-primary float-end
                        rounded')->id('guardar_info_general')->type('button') }}
                    </div>
                    {{ html()->form()->close() }}
                </div>
            </div>
            ...
            <div class="col-12 mb-4 step-section" id="ubicacion" style="display:none;">
                ...
                <div class="p-3 mb-2">
                    ...
                    <div class="d-flex justify-content-end">
                        {{ html()->button('Guardar Ubicación')->class('btn btn-primary float-end
                        guardar-seccion')->id('guardar_ubicacion')->type('button') }}
                    </div>
                </div>
                {{ html()->form()->close() }}
            </div>
            ...
            <div class="col-12 mb-4 step-section" id="organismo" style="display:none;">
                ...
                <div class="p-3 mb-2">
                    ...
                    <div class="d-flex justify-content-end">
                        {{ html()->button('Guardar Organismo')->class('btn btn-primary float-end
                        guardar-seccion')->id("guardar_organismo") }}
                    </div>
                </div>
                {{ html()->form()->close() }}
            </div>
                    ...
                    <div class="form-row mt-2">
                        <div class="form-group col-12">
                            <div class="d-flex justify-content-center align-items-center h-100">
                                {!! html()->button('<i class="fa fa-calendar mr-2 rounded"></i> AGENDA',
                                'button')->class('btn btn-agenda btn-lg w-100')->id('btn-agenda')->toHtml() !!}
                            </div>
                        </div>
                    </div>
