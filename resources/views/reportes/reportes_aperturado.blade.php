...
@section('content')
    <div class="container g-pt-40 content">
        ...
        <div class="alert alert-info" role="alert">
            <b>LA FECHA LÍMITE DEL MES DE  PARA EL ENVÍO DEL FORMATO T CORRESPONDIENTE ES EL  FALTAN DÍAS</b>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 margin-tb">
                <div>
                    <h3><b>REPORTE DE CURSOS APERTURADO</b></h3>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12">
                    {{ Form::open(['route' => 'generar.reporte.apertura', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                <button input type="submit" class="btn btn-outline-success my-2 my-sm-0 waves-effect waves-light">
