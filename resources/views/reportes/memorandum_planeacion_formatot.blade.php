...
@section('title', 'Memorandum Respuesta Positiva y Negativa Mensualmente a la Dirección de Planeación | SIVYC ICATECH')
{{-- sección del titutlo --}}
    ...
    <div class="container-fluid px-5 g-pt-20">
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2> <strong>MEMORANDUM RESPUESTA POSITIVA Y NEGATIVA MENSUALMENTE A LA DIRECCIÓN DE PLANEACIÓN</strong></h2>
