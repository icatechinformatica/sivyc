...
@push('script')
    ...
    <script src="https://resources.firma.chiapas.gob.mx:8443/tools/plugins/bootstrap-4.3.1/js/bootstrap.min.js">
    </script>
    ...
    <script
        src="https://resources.firma.chiapas.gob.mx:8443/tools/library/signedjs-2.1/signature-spv021_doctos-prueba.js">
    </script>
@endpush
