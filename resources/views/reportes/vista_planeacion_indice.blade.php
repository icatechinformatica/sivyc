...
@section('title', 'Validación FormatoT DP | SIVYC ICATECH')
    {{-- sección del titutlo --}}
...
@section('content')
    <div class="card-header">
        FormatoT / Validación FormatoT de la Dirección de Planeación
    </div>
                            ...
                            <tbody style="height: 300px; overflow-y: auto">
                                @foreach ($cursos_unidades_planeacion as $key => $datas)
                                    <tr align="center">
                                        ...
                                        <td>
                                            <div style="width:200px; word-wrap: break-word">{{ $datas->curp }}</div>
                                        </td>
                                        <td>
                                            <div style="width:200px; word-wrap: break-word">{{ $datas->rfc }}</div>
                                        </td>
