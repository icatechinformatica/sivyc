    ...
    <div class="container-fluid px-5 g-pt-30">
        ...
        <div class="row">
            <div class="col-lg-8 margin-tb">
                <div>
                    <h3><b>CURSOS REPORTADOS DE MESES ANTERIORES PARA LA UNIDAD {{ $unidad }}</b></h3>
                </div>
            </div>
        </div>

        {{ Form::open(['route' => 'cursos.reportados.historico.index', 'method' => 'GET', 'enctype' => 'multipart/form-data']) }}
            <div class="form-row">
                        ...
                        <div class="col-sm-12">
                            <table  id="table-instructor" class="table" style='width: 100%; margin-left: -1.8em;'>
                                ...
                                <tbody style="height: 300px; overflow-y: auto">
                                    @foreach ($cursos_reportados as $datas)
                                        <tr align="center" >
