    ...
    <div class= "contenedor">
        ...
        <br><br>
            <div align="justify" style="font-size:11px;">
                ...
                digitalizados con firmas y sellos de un total de {{ $total_turnado_dta[0]->total_cursos_turnado_planeacion + $total }} cursos enviados a la Unidad {{ $reg_unidad->unidad }}. De lo anterior,
