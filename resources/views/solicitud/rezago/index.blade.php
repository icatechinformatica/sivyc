...
@section('content')
    ...
    <div class="card-header">
        MODULO TEMPORAL DE APERTURAS EN SICE Y REGULARIZACION EN SIVYC
    </div>
    <div class="card card-body" style=" min-height:450px;">       
        ...
        ?>
    {{ Form::open(['route' => 'solicitud.rezago', 'method' => 'post', 'id'=>'frm']) }}
        @csrf
         <div class="row">
        ...
        @if(isset($grupo))           
            ...
            <h4><b>ALUMNOS</b></h4>
            <div class="row">
                @include('solicitud.rezago.table')
            </div>
    ...
    @section('script_content_js')                     
        ...
        <script language="javascript">  
            $(document).ready(function(){
                $("#buscar" ).click(function(){ $('#frm').attr('action', "{{route('solicitud.rezago')}}"); $('#frm').submit();}); 
                $("#guardar" ).click(function(){                    
                    if(confirm("Esta seguro de ejecutar la acción?")==true){$('#frm').attr('action', "{{route('solicitud.rezago.guardar')}}"); $('#frm').submit();}
                }); 
