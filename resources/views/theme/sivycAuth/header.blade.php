    ...
    <div class="u-header__section u-header__section--light  g-transition-0_3 g-bg-color-header" data-header-fix-moment-exclude="" data-header-fix-moment-classes="u-shadow-v18 g-py-0">
        <nav class="navbar navbar-expand-lg g-pa-0 g-pt-4 g-pb-4">
            <div class="container">
                ...
                <a href="http://www.chiapas.gob.mx" class="navbar-brand g-text-underline--hover"><img src="{{asset("img/credencial.png") }}" alt="escudo" height="50" width="150"></a>
...
<section
    ...
    data-options='{direction: "normal", settings_mode_oneelement_max_offset: "150"}' style="height: 60px">
