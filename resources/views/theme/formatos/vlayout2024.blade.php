...
<body>
    <header>
            ...
            {{-- <p style="text-align: center; font-weight: bold; font-style: italic; margin-top:-10px; padding:0px; font-size: 11px;">"2024, Año de Felipe Carrillo Puerto, Benemérito del Proletariado, Revolucionario y Defensor del Mayab"</p> --}}
        </div>
    </header>
    <footer>
