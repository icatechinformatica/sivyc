...
<head>
    ...
    <style>
        ...
        .direccion { position: absolute; top: 1.3cm; width: 95%; height: auto; font-family: sans-serif; font-size: 9px; color: #000; margin-left: 5%; }
        #fondo {
            background-image: url('img/membretado/membretado_horizontal_2026.jpg');
...
<body id="fondo">
    ...
    <footer>
        ...
        <div style="position: relative; display: flex; justify-content: flex-end;">
            <p class='direccion' style="text-align: left;">
            @php
                if(isset($direccion)){
