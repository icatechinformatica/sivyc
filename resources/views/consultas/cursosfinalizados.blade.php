    ...
    <div class="card card-body" style=" min-height:450px;">
        ...
        {{ Form::open(['method' => 'post','id'=>'frm', 'enctype' => 'multipart/form-data']) }} 
            <div class="row form-inline">
                    ...
                    {{ Form::date('fecha1', NULL , ['id'=>'fecha1', 'class' => 'form-control datepicker  mr-sm-4 mt-3', 'placeholder' => 'FECHA TERMINO 1', 'title' => 'FECHA TERMINO 1', 'required' => 'required']) }}                                        
                    {{ Form::date('fecha2', NULL , ['id'=>'fecha2', 'class' => 'form-control datepicker  mr-sm-4 mt-3', 'placeholder' => 'FECHA TERMINO 2', 'title' => 'FECHA TERMINO 2', 'required' => 'required']) }}                                       
     ...
     @section('script_content_js') 
        <script language="javascript">           
            $(document).ready(function(){ 
                $("#botonFILTRAR" ).click(function(){ $('#frm').attr('action', "{{route('consultas.cursosfinalizados')}}"); $("#frm").attr("target", '_self'); $('#frm').submit(); });
                $("#botonXLS" ).click(function(){ $('#frm').attr('action', "{{route('consultas.cursosfinalizados.xls')}}"); $("#frm").attr("target", '_blanck');$('#frm').submit();});                                
            });
            $(function() {
